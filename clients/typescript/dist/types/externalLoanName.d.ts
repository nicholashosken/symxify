import { ExternalLoanNameIdentDocFlag } from "./externalLoanNameIdentDocFlag";
import { ExternalLoanNameIdentIdDescription } from "./externalLoanNameIdentIdDescription";
import { ExternalLoanNameIdentIdExpireDate } from "./externalLoanNameIdentIdExpireDate";
import { ExternalLoanNameIdentIdIssueDate } from "./externalLoanNameIdentIdIssueDate";
import { ExternalLoanNameIdentIdNumber } from "./externalLoanNameIdentIdNumber";
import { ExternalLoanNameIdentIdType } from "./externalLoanNameIdentIdType";
import { ExternalLoanNameIdentIdVerifyDate } from "./externalLoanNameIdentIdVerifyDate";
import { VersionType } from "./versionType";
import { XmlElement } from "./xmlElement";
export interface ExternalLoanName {
    ...
    homePhone: string;
    identDocFlag: ExternalLoanNameIdentDocFlag[];
    identDocFlagSpecified: boolean;
    identIdDescription: ExternalLoanNameIdentIdDescription[];
    identIdDescriptionSpecified: boolean;
    identIdExpireDate: ExternalLoanNameIdentIdExpireDate[];
    identIdExpireDateSpecified: boolean;
    identIdIssueDate: ExternalLoanNameIdentIdIssueDate[];
    identIdIssueDateSpecified: boolean;
    identIdNumber: ExternalLoanNameIdentIdNumber[];
    identIdNumberSpecified: boolean;
    identIdType: ExternalLoanNameIdentIdType[];
    identIdTypeSpecified: boolean;
    identIdVerifyDate: ExternalLoanNameIdentIdVerifyDate[];
