import { LoanLnSegmentPmtBucketAmount_2 } from "./loanLnSegmentPmtBucketAmount_2";
import { VersionType } from "./versionType";
export interface LoanLnSegment_2 {
    ...
    pmtBucketAmount: LoanLnSegmentPmtBucketAmount_2[];
