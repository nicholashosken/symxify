import { NameIdentDocFlag } from "./nameIdentDocFlag";
import { NameIdentIdDescription } from "./nameIdentIdDescription";
import { NameIdentIdExpireDate } from "./nameIdentIdExpireDate";
import { NameIdentIdIssueDate } from "./nameIdentIdIssueDate";
import { NameIdentIdNumber } from "./nameIdentIdNumber";
import { NameIdentIdType } from "./nameIdentIdType";
import { NameIdentIdVerifyDate } from "./nameIdentIdVerifyDate";
...
export interface Name {
    ...
    homePhone: string;
    identDocFlag: NameIdentDocFlag[];
    identIdDescription: NameIdentIdDescription[];
    identIdExpireDate: NameIdentIdExpireDate[];
    identIdIssueDate: NameIdentIdIssueDate[];
    identIdNumber: NameIdentIdNumber[];
    identIdType: NameIdentIdType[];
    identIdVerifyDate: NameIdentIdVerifyDate[];
