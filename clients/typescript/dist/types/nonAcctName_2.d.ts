import { NonAcctNameIdentDocFlag_2 } from "./nonAcctNameIdentDocFlag_2";
import { NonAcctNameIdentIdDescription_2 } from "./nonAcctNameIdentIdDescription_2";
import { NonAcctNameIdentIdExpireDate_2 } from "./nonAcctNameIdentIdExpireDate_2";
import { NonAcctNameIdentIdIssueDate_2 } from "./nonAcctNameIdentIdIssueDate_2";
import { NonAcctNameIdentIdNumber_2 } from "./nonAcctNameIdentIdNumber_2";
import { NonAcctNameIdentIdType_2 } from "./nonAcctNameIdentIdType_2";
import { NonAcctNameIdentIdVerifyDate_2 } from "./nonAcctNameIdentIdVerifyDate_2";
import { VersionType } from "./versionType";
import { XmlElement } from "./xmlElement";
export interface NonAcctName_2 {
    ...
    homePhone: string;
    identDocFlag: NonAcctNameIdentDocFlag_2[];
    identDocFlagSpecified: boolean;
    identIdDescription: NonAcctNameIdentIdDescription_2[];
    identIdDescriptionSpecified: boolean;
    identIdExpireDate: NonAcctNameIdentIdExpireDate_2[];
    identIdExpireDateSpecified: boolean;
    identIdIssueDate: NonAcctNameIdentIdIssueDate_2[];
    identIdIssueDateSpecified: boolean;
    identIdNumber: NonAcctNameIdentIdNumber_2[];
    identIdNumberSpecified: boolean;
    identIdType: NonAcctNameIdentIdType_2[];
    identIdTypeSpecified: boolean;
    identIdVerifyDate: NonAcctNameIdentIdVerifyDate_2[];
