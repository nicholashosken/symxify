import { LoanPledgeNameIdentDocFlag } from "./loanPledgeNameIdentDocFlag";
import { LoanPledgeNameIdentIdDescription } from "./loanPledgeNameIdentIdDescription";
import { LoanPledgeNameIdentIdExpireDate } from "./loanPledgeNameIdentIdExpireDate";
import { LoanPledgeNameIdentIdIssueDate } from "./loanPledgeNameIdentIdIssueDate";
import { LoanPledgeNameIdentIdNumber } from "./loanPledgeNameIdentIdNumber";
import { LoanPledgeNameIdentIdType } from "./loanPledgeNameIdentIdType";
import { LoanPledgeNameIdentIdVerifyDate } from "./loanPledgeNameIdentIdVerifyDate";
import { VersionType } from "./versionType";
import { XmlElement } from "./xmlElement";
export interface LoanPledgeName {
    ...
    homePhone: string;
    identDocFlag: LoanPledgeNameIdentDocFlag[];
    identDocFlagSpecified: boolean;
    identIdDescription: LoanPledgeNameIdentIdDescription[];
    identIdDescriptionSpecified: boolean;
    identIdExpireDate: LoanPledgeNameIdentIdExpireDate[];
    identIdExpireDateSpecified: boolean;
    identIdIssueDate: LoanPledgeNameIdentIdIssueDate[];
    identIdIssueDateSpecified: boolean;
    identIdNumber: LoanPledgeNameIdentIdNumber[];
    identIdNumberSpecified: boolean;
    identIdType: LoanPledgeNameIdentIdType[];
    identIdTypeSpecified: boolean;
    identIdVerifyDate: LoanPledgeNameIdentIdVerifyDate[];
