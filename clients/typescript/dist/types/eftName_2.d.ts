import { EftNameIdentDocFlag_2 } from "./eftNameIdentDocFlag_2";
import { EftNameIdentIdDescription_2 } from "./eftNameIdentIdDescription_2";
import { EftNameIdentIdExpireDate_2 } from "./eftNameIdentIdExpireDate_2";
import { EftNameIdentIdIssueDate_2 } from "./eftNameIdentIdIssueDate_2";
import { EftNameIdentIdNumber_2 } from "./eftNameIdentIdNumber_2";
import { EftNameIdentIdType_2 } from "./eftNameIdentIdType_2";
import { EftNameIdentIdVerifyDate_2 } from "./eftNameIdentIdVerifyDate_2";
import { VersionType } from "./versionType";
export interface EftName_2 {
    ...
    homePhone: string;
    identDocFlag: EftNameIdentDocFlag_2[];
    identIdDescription: EftNameIdentIdDescription_2[];
    identIdExpireDate: EftNameIdentIdExpireDate_2[];
    identIdIssueDate: EftNameIdentIdIssueDate_2[];
    identIdNumber: EftNameIdentIdNumber_2[];
    identIdType: EftNameIdentIdType_2[];
    identIdVerifyDate: EftNameIdentIdVerifyDate_2[];
