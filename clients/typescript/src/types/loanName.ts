import { LoanNameIdentDocFlag } from "./loanNameIdentDocFlag";
import { LoanNameIdentIdDescription } from "./loanNameIdentIdDescription";
import { LoanNameIdentIdExpireDate } from "./loanNameIdentIdExpireDate";
import { LoanNameIdentIdIssueDate } from "./loanNameIdentIdIssueDate";
import { LoanNameIdentIdNumber } from "./loanNameIdentIdNumber";
import { LoanNameIdentIdType } from "./loanNameIdentIdType";
import { LoanNameIdentIdVerifyDate } from "./loanNameIdentIdVerifyDate";
...
export interface LoanName {
    ...
    homePhone: string;
    identDocFlag: LoanNameIdentDocFlag[];
    identIdDescription: LoanNameIdentIdDescription[];
    identIdExpireDate: LoanNameIdentIdExpireDate[];
    identIdIssueDate: LoanNameIdentIdIssueDate[];
    identIdNumber: LoanNameIdentIdNumber[];
    identIdType: LoanNameIdentIdType[];
    identIdVerifyDate: LoanNameIdentIdVerifyDate[];
