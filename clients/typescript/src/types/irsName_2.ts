import { IrsNameIdentDocFlag_2 } from "./irsNameIdentDocFlag_2";
import { IrsNameIdentIdDescription_2 } from "./irsNameIdentIdDescription_2";
import { IrsNameIdentIdExpireDate_2 } from "./irsNameIdentIdExpireDate_2";
import { IrsNameIdentIdIssueDate_2 } from "./irsNameIdentIdIssueDate_2";
import { IrsNameIdentIdNumber_2 } from "./irsNameIdentIdNumber_2";
import { IrsNameIdentIdType_2 } from "./irsNameIdentIdType_2";
import { IrsNameIdentIdVerifyDate_2 } from "./irsNameIdentIdVerifyDate_2";
import { VersionType } from "./versionType";
import { XmlElement } from "./xmlElement";

export interface IrsName_2 {
    ...
    homePhone: string;
    identDocFlag: IrsNameIdentDocFlag_2[];
    identDocFlagSpecified: boolean;
    identIdDescription: IrsNameIdentIdDescription_2[];
    identIdDescriptionSpecified: boolean;
    identIdExpireDate: IrsNameIdentIdExpireDate_2[];
    identIdExpireDateSpecified: boolean;
    identIdIssueDate: IrsNameIdentIdIssueDate_2[];
    identIdIssueDateSpecified: boolean;
    identIdNumber: IrsNameIdentIdNumber_2[];
    identIdNumberSpecified: boolean;
    identIdType: IrsNameIdentIdType_2[];
    identIdTypeSpecified: boolean;
    identIdVerifyDate: IrsNameIdentIdVerifyDate_2[];
