import { ShareNameIdentDocFlag_2 } from "./shareNameIdentDocFlag_2";
import { ShareNameIdentIdDescription_2 } from "./shareNameIdentIdDescription_2";
import { ShareNameIdentIdExpireDate_2 } from "./shareNameIdentIdExpireDate_2";
import { ShareNameIdentIdIssueDate_2 } from "./shareNameIdentIdIssueDate_2";
import { ShareNameIdentIdNumber_2 } from "./shareNameIdentIdNumber_2";
import { ShareNameIdentIdType_2 } from "./shareNameIdentIdType_2";
import { ShareNameIdentIdVerifyDate_2 } from "./shareNameIdentIdVerifyDate_2";
import { VersionType } from "./versionType";
import { XmlElement } from "./xmlElement";

export interface ShareName_2 {
    ...
    homePhone: string;
    identDocFlag: ShareNameIdentDocFlag_2[];
    identDocFlagSpecified: boolean;
    identIdDescription: ShareNameIdentIdDescription_2[];
    identIdDescriptionSpecified: boolean;
    identIdExpireDate: ShareNameIdentIdExpireDate_2[];
    identIdExpireDateSpecified: boolean;
    identIdIssueDate: ShareNameIdentIdIssueDate_2[];
    identIdIssueDateSpecified: boolean;
    identIdNumber: ShareNameIdentIdNumber_2[];
    identIdNumberSpecified: boolean;
    identIdType: ShareNameIdentIdType_2[];
    identIdTypeSpecified: boolean;
    identIdVerifyDate: ShareNameIdentIdVerifyDate_2[];
