import { OnlineFileThirdPartyPayments_2 } from "./onlineFileThirdPartyPayments_2";
import { VersionType } from "./versionType";

export interface OnlineFile_2 {
    ...
    thirdPartyPayments: OnlineFileThirdPartyPayments_2[];
