import { CardNameIdentDocFlag } from "./cardNameIdentDocFlag";
import { CardNameIdentIdDescription } from "./cardNameIdentIdDescription";
import { CardNameIdentIdExpireDate } from "./cardNameIdentIdExpireDate";
import { CardNameIdentIdIssueDate } from "./cardNameIdentIdIssueDate";
import { CardNameIdentIdNumber } from "./cardNameIdentIdNumber";
import { CardNameIdentIdType } from "./cardNameIdentIdType";
import { CardNameIdentIdVerifyDate } from "./cardNameIdentIdVerifyDate";
...
export interface CardName {
    ...
    homePhone: string;
    identDocFlag: CardNameIdentDocFlag[];
    identIdDescription: CardNameIdentIdDescription[];
    identIdExpireDate: CardNameIdentIdExpireDate[];
    identIdIssueDate: CardNameIdentIdIssueDate[];
    identIdNumber: CardNameIdentIdNumber[];
    identIdType: CardNameIdentIdType[];
    identIdVerifyDate: CardNameIdentIdVerifyDate[];
