import { IrsNameIdentDocFlag } from "./irsNameIdentDocFlag";
import { IrsNameIdentIdDescription } from "./irsNameIdentIdDescription";
import { IrsNameIdentIdExpireDate } from "./irsNameIdentIdExpireDate";
import { IrsNameIdentIdIssueDate } from "./irsNameIdentIdIssueDate";
import { IrsNameIdentIdNumber } from "./irsNameIdentIdNumber";
import { IrsNameIdentIdType } from "./irsNameIdentIdType";
import { IrsNameIdentIdVerifyDate } from "./irsNameIdentIdVerifyDate";
import { VersionType } from "./versionType";
import { XmlElement } from "./xmlElement";

export interface IrsName {
    ...
    homePhone: string;
    identDocFlag: IrsNameIdentDocFlag[];
    identDocFlagSpecified: boolean;
    identIdDescription: IrsNameIdentIdDescription[];
    identIdDescriptionSpecified: boolean;
    identIdExpireDate: IrsNameIdentIdExpireDate[];
    identIdExpireDateSpecified: boolean;
    identIdIssueDate: IrsNameIdentIdIssueDate[];
    identIdIssueDateSpecified: boolean;
    identIdNumber: IrsNameIdentIdNumber[];
    identIdNumberSpecified: boolean;
    identIdType: IrsNameIdentIdType[];
    identIdTypeSpecified: boolean;
    identIdVerifyDate: IrsNameIdentIdVerifyDate[];
