import { CardNameIdentDocFlag_2 } from "./cardNameIdentDocFlag_2";
import { CardNameIdentIdDescription_2 } from "./cardNameIdentIdDescription_2";
import { CardNameIdentIdExpireDate_2 } from "./cardNameIdentIdExpireDate_2";
import { CardNameIdentIdIssueDate_2 } from "./cardNameIdentIdIssueDate_2";
import { CardNameIdentIdNumber_2 } from "./cardNameIdentIdNumber_2";
import { CardNameIdentIdType_2 } from "./cardNameIdentIdType_2";
import { CardNameIdentIdVerifyDate_2 } from "./cardNameIdentIdVerifyDate_2";
import { VersionType } from "./versionType";

export interface CardName_2 {
    ...
    homePhone: string;
    identDocFlag: CardNameIdentDocFlag_2[];
    identIdDescription: CardNameIdentIdDescription_2[];
    identIdExpireDate: CardNameIdentIdExpireDate_2[];
    identIdIssueDate: CardNameIdentIdIssueDate_2[];
    identIdNumber: CardNameIdentIdNumber_2[];
    identIdType: CardNameIdentIdType_2[];
    identIdVerifyDate: CardNameIdentIdVerifyDate_2[];
