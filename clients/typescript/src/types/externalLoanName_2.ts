import { ExternalLoanNameIdentDocFlag_2 } from "./externalLoanNameIdentDocFlag_2";
import { ExternalLoanNameIdentIdDescription_2 } from "./externalLoanNameIdentIdDescription_2";
import { ExternalLoanNameIdentIdExpireDate_2 } from "./externalLoanNameIdentIdExpireDate_2";
import { ExternalLoanNameIdentIdIssueDate_2 } from "./externalLoanNameIdentIdIssueDate_2";
import { ExternalLoanNameIdentIdNumber_2 } from "./externalLoanNameIdentIdNumber_2";
import { ExternalLoanNameIdentIdType_2 } from "./externalLoanNameIdentIdType_2";
import { ExternalLoanNameIdentIdVerifyDate_2 } from "./externalLoanNameIdentIdVerifyDate_2";
import { VersionType } from "./versionType";
import { XmlElement } from "./xmlElement";

export interface ExternalLoanName_2 {
    ...
    homePhone: string;
    identDocFlag: ExternalLoanNameIdentDocFlag_2[];
    identDocFlagSpecified: boolean;
    identIdDescription: ExternalLoanNameIdentIdDescription_2[];
    identIdDescriptionSpecified: boolean;
    identIdExpireDate: ExternalLoanNameIdentIdExpireDate_2[];
    identIdExpireDateSpecified: boolean;
    identIdIssueDate: ExternalLoanNameIdentIdIssueDate_2[];
    identIdIssueDateSpecified: boolean;
    identIdNumber: ExternalLoanNameIdentIdNumber_2[];
    identIdNumberSpecified: boolean;
    identIdType: ExternalLoanNameIdentIdType_2[];
    identIdTypeSpecified: boolean;
    identIdVerifyDate: ExternalLoanNameIdentIdVerifyDate_2[];
