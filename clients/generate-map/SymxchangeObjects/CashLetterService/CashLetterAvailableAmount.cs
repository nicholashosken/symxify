...
namespace CashLetterService
{
    ...
    [XmlTypeAttribute("CashLetterAvailableAmount", Namespace="http://www.symxchange.generated.symitar.com/crud/cashletter/dto/retrieve", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CashLetterAvailableAmount
    {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("AvailableAmount", Order=1, Form=XmlSchemaForm.Unqualified)]
        public decimal AvailableAmountValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the AvailableAmount property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool AvailableAmountValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<decimal> AvailableAmount
        {
            get
            {
                if (this.AvailableAmountValueSpecified)
                {
            ...
            set
            {
                this.AvailableAmountValue = value.GetValueOrDefault();
                this.AvailableAmountValueSpecified = value.HasValue;
            }
        }
    }
}
