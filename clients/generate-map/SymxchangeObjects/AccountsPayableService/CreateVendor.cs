...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("createVendor", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("createVendor", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable")]
    public partial class CreateVendor
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public CreateVendorRequest Request { get; set; }
    }
}
