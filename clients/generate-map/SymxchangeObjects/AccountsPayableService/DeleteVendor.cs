...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("deleteVendor", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("deleteVendor", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable")]
    public partial class DeleteVendor
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public DeleteVendorRequest Request { get; set; }
    }
}
