...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("VendorFmHistorySearchPagedSelectFieldsRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class VendorFmHistorySearchPagedSelectFieldsRequest
    {
        ...
        public AccountsPayableService.PagingRequestContext PagingRequestContext { get; set; }
        
        [XmlElementAttribute("SelectableFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public AccountsPayableService.VendorFmHistorySingleSelectableFields SelectableFields { get; set; }
        
        [XmlElementAttribute("SearchFilter", Order=5, Form=XmlSchemaForm.Unqualified)]
        public AccountsPayableService.VendorFmHistorySearchFilter SearchFilter { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="VendorFmHistorySearchPagedSelectFieldsRequest" /> class.</para>
        /// </summary>
        public VendorFmHistorySearchPagedSelectFieldsRequest()
        {
