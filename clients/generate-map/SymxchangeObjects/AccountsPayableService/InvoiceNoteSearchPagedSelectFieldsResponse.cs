...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("InvoiceNoteSearchPagedSelectFieldsResponse", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class InvoiceNoteSearchPagedSelectFieldsResponse
    {
        
        [XmlIgnoreAttribute()]
        private Collection<AccountsPayableService.InvoiceNote> _invoiceNote;
        
        [XmlElementAttribute("InvoiceNote", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<AccountsPayableService.InvoiceNote> InvoiceNote
        {
            get
            {
                return _invoiceNote;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="InvoiceNoteSearchPagedSelectFieldsResponse" /> class.</para>
        /// </summary>
        public InvoiceNoteSearchPagedSelectFieldsResponse()
        {
            this._invoiceNote = new Collection<AccountsPayableService.InvoiceNote>();
