...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("InvoiceNote", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("InvoiceNote", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable/dto/update")]
    [XmlIncludeAttribute(typeof(InvoiceNoteFields_2))]
    public partial class InvoiceNote_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoiceNoteText_2> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoiceNoteText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="InvoiceNote_2" /> class.</para>
        /// </summary>
        public InvoiceNote_2()
        {
            this._text = new Collection<InvoiceNoteText_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("UserId", Order=9, Form=XmlSchemaForm.Unqualified)]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("VoidFlag", Order=10, Form=XmlSchemaForm.Unqualified)]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("VoidedBy", Order=11, Form=XmlSchemaForm.Unqualified)]
