...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("InvoiceList", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable/dto/retrieve")]
    ...
    public partial class InvoiceList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Invoice> _invoice;
        
        [XmlElementAttribute("Invoice", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Invoice> Invoice
        {
            get
            {
                return _invoice;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="InvoiceList" /> class.</para>
        /// </summary>
        public InvoiceList()
        {
            this._invoice = new Collection<Invoice>();
        }
    }
}
