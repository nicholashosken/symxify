...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("CreateInvoiceRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable")]
    ...
    public partial class CreateInvoiceRequest
    {
        ...
        [XmlElementAttribute("InvoiceFields", Order=3, Form=XmlSchemaForm.Unqualified)]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CreateInvoiceRequest" /> class.</para>
        /// </summary>
