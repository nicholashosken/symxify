...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("InvoiceUpdateRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable/dto/update")]
    ...
    public partial class InvoiceUpdateRequest
    {
        ...
        [XmlElementAttribute("InvoiceLocator", Order=0, Form=XmlSchemaForm.Unqualified)]
        ...
        public InvoiceFields_2 InvoiceFields { get; set; }
    }
}
