...
namespace ExceptionItemService
{
    ...
    [XmlTypeAttribute("ExcpAddInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/exceptionitem/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ExcpAddInfo
    {
        
        [XmlIgnoreAttribute()]
        private Collection<ExcpAddInfoAdditionInfo> _additionInfo;
        
        [XmlElementAttribute("AdditionInfo", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExcpAddInfoAdditionInfo> AdditionInfo
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ExcpAddInfo" /> class.</para>
        /// </summary>
        public ExcpAddInfo()
        {
            this._additionInfo = new Collection<ExcpAddInfoAdditionInfo>();
