...
namespace ExceptionItemService
{
    ...
    [XmlTypeAttribute("ExcpAddendaSelectFieldsRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/exceptionitem")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ExcpAddendaSelectFieldsRequest
    {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("ExcpAddendaLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int ExcpAddendaLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the ExcpAddendaLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool ExcpAddendaLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> ExcpAddendaLocator
        {
            get
            {
                if (this.ExcpAddendaLocatorValueSpecified)
                {
                    return this.ExcpAddendaLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.ExcpAddendaLocatorValue = value.GetValueOrDefault();
                this.ExcpAddendaLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        public ExceptionItemService.ExcpAddendaSingleSelectableFields SelectableFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ExcpAddendaSelectFieldsRequest" /> class.</para>
        /// </summary>
        public ExcpAddendaSelectFieldsRequest()
        {
