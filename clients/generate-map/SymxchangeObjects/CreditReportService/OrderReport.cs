...
namespace CreditReportService
{
    ...
    [XmlTypeAttribute("orderReport", Namespace="http://www.symxchange.generated.symitar.com/noncrud/creditreport", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("orderReport", Namespace="http://www.symxchange.generated.symitar.com/noncrud/creditreport")]
    public partial class OrderReport
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public CreditReportService.OrderReportRequest Request { get; set; }
    }
}
