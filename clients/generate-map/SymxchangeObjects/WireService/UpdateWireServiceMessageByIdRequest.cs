...
namespace WireService
{
    ...
    [XmlTypeAttribute("UpdateWireServiceMessageByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/wire")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateWireServiceMessageByIdRequest
    {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("WireServiceMessageLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int WireServiceMessageLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the WireServiceMessageLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool WireServiceMessageLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> WireServiceMessageLocator
        {
            get
            {
                if (this.WireServiceMessageLocatorValueSpecified)
                {
                    return this.WireServiceMessageLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.WireServiceMessageLocatorValue = value.GetValueOrDefault();
                this.WireServiceMessageLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("WireServiceMessageFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public WireService.WireServiceMessageFields_2 WireServiceMessageFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateWireServiceMessageByIdRequest" /> class.</para>
        /// </summary>
        public UpdateWireServiceMessageByIdRequest()
        {
