...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireBeneficiaryFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireBeneficiaryFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireBeneficiaryFiInfo
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireBeneficiaryFiInfoText> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireBeneficiaryFiInfoText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireBeneficiaryFiInfo" /> class.</para>
        /// </summary>
        public WireBeneficiaryFiInfo()
        {
            this._text = new Collection<WireBeneficiaryFiInfoText>();
