...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireReceiverFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireReceiverFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireReceiverFiInfo
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireReceiverFiInfoText> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireReceiverFiInfoText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireReceiverFiInfo" /> class.</para>
        /// </summary>
        public WireReceiverFiInfo()
        {
            this._text = new Collection<WireReceiverFiInfoText>();
