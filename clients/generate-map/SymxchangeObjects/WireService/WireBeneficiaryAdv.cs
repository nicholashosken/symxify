...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireBeneficiaryAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireBeneficiaryAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireBeneficiaryAdv
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireBeneficiaryAdvText> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireBeneficiaryAdvText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireBeneficiaryAdv" /> class.</para>
        /// </summary>
        public WireBeneficiaryAdv()
        {
            this._text = new Collection<WireBeneficiaryAdvText>();
