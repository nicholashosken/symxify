...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireDrawdownDebitAcctAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireDrawdownDebitAcctAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireDrawdownDebitAcctAdv
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireDrawdownDebitAcctAdvText> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireDrawdownDebitAcctAdvText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireDrawdownDebitAcctAdv" /> class.</para>
        /// </summary>
        public WireDrawdownDebitAcctAdv()
        {
            this._text = new Collection<WireDrawdownDebitAcctAdvText>();
