...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireCreditorSubdepartment", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireCreditorSubdepartment", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireCreditorSubdepartment
    {
        ...
        [XmlElementAttribute("CreditorSubdepartment", Order=1, Form=XmlSchemaForm.Unqualified)]
        public string CreditorSubdepartment { get; set; }
    }
}
