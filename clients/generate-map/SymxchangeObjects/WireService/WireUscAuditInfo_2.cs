...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireUscAuditInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireUscAuditInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireUscAuditInfoFields_2))]
    public partial class WireUscAuditInfo_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireUscAuditInfoText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireUscAuditInfoText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireUscAuditInfo_2" /> class.</para>
        /// </summary>
        public WireUscAuditInfo_2()
        {
            this._text = new Collection<WireUscAuditInfoText_2>();
