...
namespace CheckService
{
    ...
    [XmlTypeAttribute("CheckFmHistoryList", Namespace="http://www.symxchange.generated.symitar.com/crud/check/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CheckFmHistoryList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CheckFmHistory> _checkFmHistory;
        
        [XmlElementAttribute("CheckFmHistory", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CheckFmHistory> CheckFmHistory
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CheckFmHistoryList" /> class.</para>
        /// </summary>
        public CheckFmHistoryList()
        {
            this._checkFmHistory = new Collection<CheckFmHistory>();
        }
    }
}
