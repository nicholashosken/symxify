...
namespace CollateralService
{
    ...
    [XmlTypeAttribute("CollateralFmHistorySearchPagedSelectFieldsRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/collateral")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CollateralFmHistorySearchPagedSelectFieldsRequest
    {
        ...
        public CollateralService.PagingRequestContext PagingRequestContext { get; set; }
        
        [XmlElementAttribute("SelectableFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public CollateralService.CollateralFmHistorySingleSelectableFields SelectableFields { get; set; }
        
        [XmlElementAttribute("SearchFilter", Order=5, Form=XmlSchemaForm.Unqualified)]
        public CollateralService.CollateralFmHistorySearchFilter SearchFilter { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CollateralFmHistorySearchPagedSelectFieldsRequest" /> class.</para>
        /// </summary>
        public CollateralFmHistorySearchPagedSelectFieldsRequest()
        {
