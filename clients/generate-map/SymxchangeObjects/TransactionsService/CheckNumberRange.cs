...
namespace TransactionsService
{
    ...
    [XmlTypeAttribute("CheckNumberRange", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CheckNumberRange
    {
        ...
        [XmlElementAttribute("BeginningCheckNumber", Order=0, Form=XmlSchemaForm.Unqualified)]
        public string BeginningCheckNumber { get; set; }
        ...
        [RegularExpressionAttribute("[0-9]+")]
        [RequiredAttribute(AllowEmptyStrings=false)]
        [XmlElementAttribute("EndingCheckNumber", Order=1, Form=XmlSchemaForm.Unqualified)]
        public string EndingCheckNumber { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CheckNumberRange" /> class.</para>
        /// </summary>
        public CheckNumberRange()
        {
