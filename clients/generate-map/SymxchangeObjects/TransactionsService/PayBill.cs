...
namespace TransactionsService
{
    ...
    [XmlTypeAttribute("payBill", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("payBill", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions")]
    public partial class PayBill
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public TransactionsService.BillPaymentRequest Request { get; set; }
    }
}
