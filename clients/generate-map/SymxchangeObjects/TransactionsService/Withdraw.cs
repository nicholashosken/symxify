...
namespace TransactionsService
{
    ...
    [XmlTypeAttribute("withdraw", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("withdraw", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions")]
    public partial class Withdraw
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public TransactionsService.WithdrawalRequest Request { get; set; }
    }
}
