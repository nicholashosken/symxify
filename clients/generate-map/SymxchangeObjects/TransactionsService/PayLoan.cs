...
namespace TransactionsService
{
    ...
    [XmlTypeAttribute("payLoan", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("payLoan", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions")]
    public partial class PayLoan
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public TransactionsService.LoanPaymentRequest Request { get; set; }
    }
}
