...
namespace UserService
{
    ...
    [XmlTypeAttribute("UserTrackingList", Namespace="http://www.symxchange.generated.symitar.com/crud/user/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UserTrackingList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<UserTracking> _userTracking;
        
        [XmlElementAttribute("UserTracking", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<UserTracking> UserTracking
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UserTrackingList" /> class.</para>
        /// </summary>
        public UserTrackingList()
        {
            this._userTracking = new Collection<UserTracking>();
        }
    }
}
