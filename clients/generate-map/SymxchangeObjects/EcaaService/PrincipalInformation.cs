...
namespace EcaaService
{
    ...
    [XmlTypeAttribute("principalInformation", Namespace="http://www.symxchange.generated.symitar.com/noncrud/ecaa/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class PrincipalInformation
    {
        
        [XmlElementAttribute("Principal", Order=0, Form=XmlSchemaForm.Unqualified)]
        public string Principal { get; set; }
        
        [XmlElementAttribute("Name", Order=1, Form=XmlSchemaForm.Unqualified)]
        public string Name { get; set; }
        
        [XmlElementAttribute("Phone", Order=2, Form=XmlSchemaForm.Unqualified)]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="PrincipalInformation" /> class.</para>
        /// </summary>
