...
namespace EcaaService
{
    ...
    [XmlTypeAttribute("authenticateService", Namespace="http://www.symxchange.generated.symitar.com/noncrud/ecaa", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("authenticateService", Namespace="http://www.symxchange.generated.symitar.com/noncrud/ecaa")]
    public partial class AuthenticateService
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public EcaaService.AuthenticateServiceRequest Request { get; set; }
    }
}
