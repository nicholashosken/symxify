...
namespace EcaaService
{
    ...
    [XmlTypeAttribute("convertToSAMLRequest", Namespace="http://www.symxchange.generated.symitar.com/noncrud/ecaa/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ConvertToSamlRequest : EcaaBaseRequest
    {
        
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("JwtToken", Order=0, Form=XmlSchemaForm.Unqualified)]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ConvertToSamlRequest" /> class.</para>
        /// </summary>
        public ConvertToSamlRequest()
        {
