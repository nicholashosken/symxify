...
namespace FileManagementService
{
    ...
    [XmlTypeAttribute("FileManagementBaseResponse", Namespace="http://www.symxchange.generated.symitar.com/noncrud/filemanagement/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlIncludeAttribute(typeof(DeleteResponse))]
    [XmlIncludeAttribute(typeof(DownloadResponse))]
    [XmlIncludeAttribute(typeof(UploadResponse))]
    public partial class FileManagementBaseResponse
    {
        
        [XmlElementAttribute("Status", Order=0, Form=XmlSchemaForm.Unqualified)]
        public FileManagementService.Status Status { get; set; }
