...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("CtrPersonList", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CtrPersonList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CtrPerson> _ctrPerson;
        
        [XmlElementAttribute("CtrPerson", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CtrPerson> CtrPerson
        {
            get
            {
                return _ctrPerson;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CtrPersonList" /> class.</para>
        /// </summary>
        public CtrPersonList()
        {
            this._ctrPerson = new Collection<CtrPerson>();
        }
    }
}
