...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("CtrAccountList", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CtrAccountList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CtrAccount> _ctrAccount;
        
        [XmlElementAttribute("CtrAccount", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CtrAccount> CtrAccount
        {
            get
            {
                return _ctrAccount;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CtrAccountList" /> class.</para>
        /// </summary>
        public CtrAccountList()
        {
            this._ctrAccount = new Collection<CtrAccount>();
        }
    }
}
