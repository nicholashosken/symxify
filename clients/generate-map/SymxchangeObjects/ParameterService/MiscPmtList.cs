...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("MiscPmtList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class MiscPmtList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<MiscPmt> _miscPmt;
        
        [XmlElementAttribute("MiscPmt", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<MiscPmt> MiscPmt
        {
            get
            {
                return _miscPmt;
        ...
        /// <summary>
        /// <para xml:lang="en">Gets a value indicating whether the MiscPmt collection is empty.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        public bool MiscPmtSpecified
        {
            get
            {
                return ((this.MiscPmt != null) 
                            && (this.MiscPmt.Count != 0));
            }
        }
        
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="MiscPmtList" /> class.</para>
        /// </summary>
        public MiscPmtList()
        {
            this._miscPmt = new Collection<MiscPmt>();
        }
    }
}
