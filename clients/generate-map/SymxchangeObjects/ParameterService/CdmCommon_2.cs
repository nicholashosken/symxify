...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("CdmCommon", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CdmCommon", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(CdmCommonFields_2))]
    public partial class CdmCommon_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CdmCommonCdmDuressAutoMixDescr_2> _cdmDuressAutoMixDescr;
        
        [XmlElementAttribute("CdmDuressAutoMixDescr", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CdmCommonCdmDuressAutoMixDescr_2> CdmDuressAutoMixDescr
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CdmCommon_2" /> class.</para>
        /// </summary>
        public CdmCommon_2()
        {
            this._cdmDuressAutoMixDescr = new Collection<CdmCommonCdmDuressAutoMixDescr_2>();
