...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("Stock", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("Stock", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(StockFields_2))]
    public partial class Stock_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<StockTypeFractionPrice_2> _typeFractionPrice;
        
        [XmlElementAttribute("TypeFractionPrice", Order=4, Form=XmlSchemaForm.Unqualified)]
        public Collection<StockTypeFractionPrice_2> TypeFractionPrice
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="Stock_2" /> class.</para>
        /// </summary>
        public Stock_2()
        {
            this._typeFractionPrice = new Collection<StockTypeFractionPrice_2>();
