...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("InstitutionList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    ...
    public partial class InstitutionList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Institution> _institution;
        
        [XmlElementAttribute("Institution", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Institution> Institution
        {
            get
            {
                return _institution;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="InstitutionList" /> class.</para>
        /// </summary>
        public InstitutionList()
        {
            this._institution = new Collection<Institution>();
        }
    }
}
