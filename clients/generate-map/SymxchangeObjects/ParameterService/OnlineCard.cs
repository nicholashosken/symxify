...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("OnlineCard", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("OnlineCard", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class OnlineCard
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<OnlineCardLimitCustomCondition> _limitCustomCondition;
        
        [XmlElementAttribute("LimitCustomCondition", Order=33, Form=XmlSchemaForm.Unqualified)]
        public Collection<OnlineCardLimitCustomCondition> LimitCustomCondition
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="OnlineCard" /> class.</para>
        /// </summary>
        public OnlineCard()
        {
            this._limitCustomCondition = new Collection<OnlineCardLimitCustomCondition>();
            this._limitDescription = new Collection<OnlineCardLimitDescription>();
            this._limitMcc = new Collection<OnlineCardLimitMcc>();
            this._limitSourceCodes = new Collection<OnlineCardLimitSourceCodes>();
            this._limitTransactionCodes = new Collection<OnlineCardLimitTransactionCodes>();
            this._limitTransactionSubTypes = new Collection<OnlineCardLimitTransactionSubTypes>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<OnlineCardLimitDescription> _limitDescription;
        
        [XmlElementAttribute("LimitDescription", Order=34, Form=XmlSchemaForm.Unqualified)]
        public Collection<OnlineCardLimitDescription> LimitDescription
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<OnlineCardLimitMcc> _limitMcc;
        
        [XmlElementAttribute("LimitMcc", Order=35, Form=XmlSchemaForm.Unqualified)]
        public Collection<OnlineCardLimitMcc> LimitMcc
        {
            get
            {
                return _limitMcc;
        ...
        [XmlIgnoreAttribute()]
        private Collection<OnlineCardLimitSourceCodes> _limitSourceCodes;
        
        [XmlElementAttribute("LimitSourceCodes", Order=36, Form=XmlSchemaForm.Unqualified)]
        public Collection<OnlineCardLimitSourceCodes> LimitSourceCodes
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<OnlineCardLimitTransactionCodes> _limitTransactionCodes;
        
        [XmlElementAttribute("LimitTransactionCodes", Order=37, Form=XmlSchemaForm.Unqualified)]
        public Collection<OnlineCardLimitTransactionCodes> LimitTransactionCodes
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<OnlineCardLimitTransactionSubTypes> _limitTransactionSubTypes;
        
        [XmlElementAttribute("LimitTransactionSubTypes", Order=38, Form=XmlSchemaForm.Unqualified)]
        public Collection<OnlineCardLimitTransactionSubTypes> LimitTransactionSubTypes
        {
            get
            {
