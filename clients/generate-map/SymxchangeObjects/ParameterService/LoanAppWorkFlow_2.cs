...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("LoanAppWorkFlow", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanAppWorkFlow", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(LoanAppWorkFlowFields_2))]
    public partial class LoanAppWorkFlow_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppWorkFlowEvent_2> _event;
        
        [XmlElementAttribute("Event", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppWorkFlowEvent_2> Event
        {
            get
            {
                return _event;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanAppWorkFlow_2" /> class.</para>
        /// </summary>
        public LoanAppWorkFlow_2()
        {
            this._event = new Collection<LoanAppWorkFlowEvent_2>();
