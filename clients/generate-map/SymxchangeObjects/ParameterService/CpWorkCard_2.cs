...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("CpWorkCard", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CpWorkCard", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(CpWorkCardFields_2))]
    public partial class CpWorkCard_2
    {
        
        [XmlIgnoreAttribute()]
        private Collection<CpWorkCardAdditionalInfoHeader_2> _additionalInfoHeader;
        
        [XmlElementAttribute("AdditionalInfoHeader", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<CpWorkCardAdditionalInfoHeader_2> AdditionalInfoHeader
        {
            get
            {
        ...
        public CpWorkCard_2()
        {
            this._additionalInfoHeader = new Collection<CpWorkCardAdditionalInfoHeader_2>();
            this._additionalInfoJustify = new Collection<CpWorkCardAdditionalInfoJustify_2>();
            this._workCardDescriptionType = new Collection<CpWorkCardWorkCardDescriptionType_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<CpWorkCardAdditionalInfoJustify_2> _additionalInfoJustify;
        
        [XmlElementAttribute("AdditionalInfoJustify", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CpWorkCardAdditionalInfoJustify_2> AdditionalInfoJustify
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CpWorkCardWorkCardDescriptionType_2> _workCardDescriptionType;
        
        [XmlElementAttribute("WorkCardDescriptionType", Order=7, Form=XmlSchemaForm.Unqualified)]
        public Collection<CpWorkCardWorkCardDescriptionType_2> WorkCardDescriptionType
        {
            get
            {
