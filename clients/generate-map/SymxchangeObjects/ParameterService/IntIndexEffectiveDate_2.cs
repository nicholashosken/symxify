...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("IntIndexEffectiveDate", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("IntIndexEffectiveDate", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    public partial class IntIndexEffectiveDate_2
    {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("EffectiveDate", Order=1, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
