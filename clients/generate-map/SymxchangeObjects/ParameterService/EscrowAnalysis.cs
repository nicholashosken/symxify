...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("EscrowAnalysis", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("EscrowAnalysis", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class EscrowAnalysis
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<EscrowAnalysisDeficiencyGeAmount> _deficiencyGeAmount;
        
        [XmlElementAttribute("DeficiencyGeAmount", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<EscrowAnalysisDeficiencyGeAmount> DeficiencyGeAmount
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="EscrowAnalysis" /> class.</para>
        /// </summary>
        public EscrowAnalysis()
        {
            this._deficiencyGeAmount = new Collection<EscrowAnalysisDeficiencyGeAmount>();
            this._deficiencyGeNbrOfMonths = new Collection<EscrowAnalysisDeficiencyGeNbrOfMonths>();
            this._deficiencyLtAmount = new Collection<EscrowAnalysisDeficiencyLtAmount>();
            this._deficiencyLtNbrOfMonths = new Collection<EscrowAnalysisDeficiencyLtNbrOfMonths>();
            this._shortageGeAmount = new Collection<EscrowAnalysisShortageGeAmount>();
            this._shortageGeNbrOfMonths = new Collection<EscrowAnalysisShortageGeNbrOfMonths>();
            this._shortageLtAmount = new Collection<EscrowAnalysisShortageLtAmount>();
            this._shortageLtNbrOfMonths = new Collection<EscrowAnalysisShortageLtNbrOfMonths>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<EscrowAnalysisDeficiencyGeNbrOfMonths> _deficiencyGeNbrOfMonths;
        
        [XmlElementAttribute("DeficiencyGeNbrOfMonths", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<EscrowAnalysisDeficiencyGeNbrOfMonths> DeficiencyGeNbrOfMonths
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<EscrowAnalysisDeficiencyLtAmount> _deficiencyLtAmount;
        
        [XmlElementAttribute("DeficiencyLtAmount", Order=5, Form=XmlSchemaForm.Unqualified)]
        public Collection<EscrowAnalysisDeficiencyLtAmount> DeficiencyLtAmount
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<EscrowAnalysisDeficiencyLtNbrOfMonths> _deficiencyLtNbrOfMonths;
        
        [XmlElementAttribute("DeficiencyLtNbrOfMonths", Order=6, Form=XmlSchemaForm.Unqualified)]
        public Collection<EscrowAnalysisDeficiencyLtNbrOfMonths> DeficiencyLtNbrOfMonths
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<EscrowAnalysisShortageGeAmount> _shortageGeAmount;
        
        [XmlElementAttribute("ShortageGeAmount", Order=13, Form=XmlSchemaForm.Unqualified)]
        public Collection<EscrowAnalysisShortageGeAmount> ShortageGeAmount
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<EscrowAnalysisShortageGeNbrOfMonths> _shortageGeNbrOfMonths;
        
        [XmlElementAttribute("ShortageGeNbrOfMonths", Order=14, Form=XmlSchemaForm.Unqualified)]
        public Collection<EscrowAnalysisShortageGeNbrOfMonths> ShortageGeNbrOfMonths
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<EscrowAnalysisShortageLtAmount> _shortageLtAmount;
        
        [XmlElementAttribute("ShortageLtAmount", Order=16, Form=XmlSchemaForm.Unqualified)]
        public Collection<EscrowAnalysisShortageLtAmount> ShortageLtAmount
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<EscrowAnalysisShortageLtNbrOfMonths> _shortageLtNbrOfMonths;
        
        [XmlElementAttribute("ShortageLtNbrOfMonths", Order=17, Form=XmlSchemaForm.Unqualified)]
        public Collection<EscrowAnalysisShortageLtNbrOfMonths> ShortageLtNbrOfMonths
        {
            get
            {
