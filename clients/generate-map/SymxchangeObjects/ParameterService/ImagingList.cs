...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("ImagingList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ImagingList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Imaging> _imaging;
        
        [XmlElementAttribute("Imaging", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Imaging> Imaging
        {
            get
            {
                return _imaging;
        ...
        /// <summary>
        /// <para xml:lang="en">Gets a value indicating whether the Imaging collection is empty.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        public bool ImagingSpecified
        {
            get
            {
                return ((this.Imaging != null) 
                            && (this.Imaging.Count != 0));
            }
        }
        
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ImagingList" /> class.</para>
        /// </summary>
        public ImagingList()
        {
            this._imaging = new Collection<Imaging>();
        }
    }
}
