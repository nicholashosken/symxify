...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("CdmList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CdmList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Cdm> _cdm;
        
        [XmlElementAttribute("Cdm", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Cdm> Cdm
        {
            get
            {
                return _cdm;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CdmList" /> class.</para>
        /// </summary>
        public CdmList()
        {
            this._cdm = new Collection<Cdm>();
        }
    }
}
