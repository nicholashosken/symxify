...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("RegCcList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class RegCcList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<RegCc> _regCc;
        
        [XmlElementAttribute("RegCc", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<RegCc> RegCc
        {
            get
            {
                return _regCc;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="RegCcList" /> class.</para>
        /// </summary>
        public RegCcList()
        {
            this._regCc = new Collection<RegCc>();
        }
    }
}
