...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("BatchRcList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class BatchRcList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<BatchRc> _batchRc;
        
        [XmlElementAttribute("BatchRc", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<BatchRc> BatchRc
        {
            get
            {
                return _batchRc;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="BatchRcList" /> class.</para>
        /// </summary>
        public BatchRcList()
        {
            this._batchRc = new Collection<BatchRc>();
        }
    }
}
