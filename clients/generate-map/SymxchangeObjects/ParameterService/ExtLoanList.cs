...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("ExtLoanList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ExtLoanList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ExtLoan> _extLoan;
        
        [XmlElementAttribute("ExtLoan", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExtLoan> ExtLoan
        {
            get
            {
                return _extLoan;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ExtLoanList" /> class.</para>
        /// </summary>
        public ExtLoanList()
        {
            this._extLoan = new Collection<ExtLoan>();
        }
    }
}
