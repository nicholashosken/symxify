...
namespace PowerOnService
{
    ...
    [XmlTypeAttribute("UserDate", Namespace="http://www.symxchange.generated.symitar.com/noncrud/poweron/dto")]
    ...
    public partial class UserDate
    {
        ...
        /// </summary>
        [RangeAttribute(typeof(short), "1", "15")]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UserDate" /> class.</para>
        /// </summary>
        public UserDate()
        {
