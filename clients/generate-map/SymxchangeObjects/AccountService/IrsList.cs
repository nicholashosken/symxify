...
namespace AccountService
{
    ...
    [XmlTypeAttribute("IrsList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class IrsList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Irs> _irs;
        
        [XmlElementAttribute("Irs", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Irs> Irs
        {
            get
            {
                return _irs;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="IrsList" /> class.</para>
        /// </summary>
        public IrsList()
        {
            this._irs = new Collection<Irs>();
        }
    }
}
