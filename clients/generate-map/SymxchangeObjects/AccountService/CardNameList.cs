...
namespace AccountService
{
    ...
    [XmlTypeAttribute("CardNameList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CardNameList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardName> _cardName;
        
        [XmlElementAttribute("CardName", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardName> CardName
        {
            get
            {
                return _cardName;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CardNameList" /> class.</para>
        /// </summary>
        public CardNameList()
        {
            this._cardName = new Collection<CardName>();
        }
    }
}
