...
namespace AccountService
{
    ...
    [XmlTypeAttribute("PortfolioNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("PortfolioNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class PortfolioNote
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<PortfolioNoteText> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<PortfolioNoteText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="PortfolioNote" /> class.</para>
        /// </summary>
        public PortfolioNote()
        {
            this._text = new Collection<PortfolioNoteText>();
