...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateLoanPledgeNameByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateLoanPledgeNameByIdRequest
    {
        
        [XmlElementAttribute("AccountNumber", Order=0, Form=XmlSchemaForm.Unqualified)]
        public string AccountNumber { get; set; }
        
        [XmlElementAttribute("LoanId", Order=1, Form=XmlSchemaForm.Unqualified)]
        public string LoanId { get; set; }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("LoanPledgeLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int LoanPledgeLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the LoanPledgeLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool LoanPledgeLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> LoanPledgeLocator
        {
            get
            {
                if (this.LoanPledgeLocatorValueSpecified)
                {
                    return this.LoanPledgeLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.LoanPledgeLocatorValue = value.GetValueOrDefault();
                this.LoanPledgeLocatorValueSpecified = value.HasValue;
            }
        }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("LoanPledgeNameLocator", Order=3, Form=XmlSchemaForm.Unqualified)]
        ...
        [XmlElementAttribute("LoanPledgeNameFields", Order=6, Form=XmlSchemaForm.Unqualified)]
        public AccountService.LoanPledgeNameFields_2 LoanPledgeNameFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateLoanPledgeNameByIdRequest" /> class.</para>
        /// </summary>
        public UpdateLoanPledgeNameByIdRequest()
        {
