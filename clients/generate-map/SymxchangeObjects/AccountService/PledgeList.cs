...
namespace AccountService
{
    ...
    [XmlTypeAttribute("PledgeList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    ...
    public partial class PledgeList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Pledge> _pledge;
        
        [XmlElementAttribute("Pledge", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Pledge> Pledge
        {
            get
            {
                return _pledge;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="PledgeList" /> class.</para>
        /// </summary>
        public PledgeList()
        {
            this._pledge = new Collection<Pledge>();
        }
    }
}
