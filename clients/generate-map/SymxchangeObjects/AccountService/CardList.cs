...
namespace AccountService
{
    ...
    [XmlTypeAttribute("CardList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    ...
    public partial class CardList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Card> _card;
        
        [XmlElementAttribute("Card", Order=1, Form=XmlSchemaForm.Unqualified)]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CardList" /> class.</para>
        /// </summary>
        public CardList()
        {
            this._card = new Collection<Card>();
        }
    }
}
