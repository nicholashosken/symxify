...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanAppList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class LoanAppList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanApp> _loanApp;
        
        [XmlElementAttribute("LoanApp", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanApp> LoanApp
        {
            get
            {
                return _loanApp;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanAppList" /> class.</para>
        /// </summary>
        public LoanAppList()
        {
            this._loanApp = new Collection<LoanApp>();
        }
    }
}
