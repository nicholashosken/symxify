...
namespace AccountService
{
    ...
    [XmlTypeAttribute("ExternalLoanNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("ExternalLoanNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class ExternalLoanNote
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ExternalLoanNoteText> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExternalLoanNoteText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ExternalLoanNote" /> class.</para>
        /// </summary>
        public ExternalLoanNote()
        {
            this._text = new Collection<ExternalLoanNoteText>();
