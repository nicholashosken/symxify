...
namespace AccountService
{
    ...
    [XmlTypeAttribute("ShareNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("ShareNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(ShareNoteFields_2))]
    public partial class ShareNote_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareNoteText_2> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareNoteText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ShareNote_2" /> class.</para>
        /// </summary>
        public ShareNote_2()
        {
            this._text = new Collection<ShareNoteText_2>();
