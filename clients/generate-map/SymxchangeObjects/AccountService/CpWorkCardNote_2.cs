...
namespace AccountService
{
    ...
    [XmlTypeAttribute("CpWorkCardNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CpWorkCardNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(CpWorkCardNoteFields_2))]
    public partial class CpWorkCardNote_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CpWorkCardNoteText_2> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<CpWorkCardNoteText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CpWorkCardNote_2" /> class.</para>
        /// </summary>
        public CpWorkCardNote_2()
        {
            this._text = new Collection<CpWorkCardNoteText_2>();
