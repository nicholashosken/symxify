...
namespace AccountService
{
    ...
    [XmlTypeAttribute("Note", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("Note", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(NoteFields_2))]
    public partial class Note_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<NoteText_2> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<NoteText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="Note_2" /> class.</para>
        /// </summary>
        public Note_2()
        {
            this._text = new Collection<NoteText_2>();
