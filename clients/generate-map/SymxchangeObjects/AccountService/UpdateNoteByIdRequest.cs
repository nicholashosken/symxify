...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateNoteByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateNoteByIdRequest
    {
        ...
        [XmlElementAttribute("NoteLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int NoteLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the NoteLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool NoteLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> NoteLocator
        {
            get
            {
                if (this.NoteLocatorValueSpecified)
                {
                    return this.NoteLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.NoteLocatorValue = value.GetValueOrDefault();
                this.NoteLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("NoteFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public AccountService.NoteFields_2 NoteFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateNoteByIdRequest" /> class.</para>
        /// </summary>
        public UpdateNoteByIdRequest()
        {
