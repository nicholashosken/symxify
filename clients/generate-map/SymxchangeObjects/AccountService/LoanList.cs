...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    ...
    public partial class LoanList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Loan> _loan;
        
        [XmlElementAttribute("Loan", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Loan> Loan
        {
            get
            {
                return _loan;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanList" /> class.</para>
        /// </summary>
        public LoanList()
        {
            this._loan = new Collection<Loan>();
        }
    }
}
