...
namespace AccountService
{
    ...
    [XmlTypeAttribute("BatchAchOrig", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("BatchAchOrig", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(BatchAchOrigFields_2))]
    public partial class BatchAchOrig_2
    {
        ...
        [XmlElementAttribute("DepositSettlementDate", Order=4, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> DepositSettlementDateValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("EffectiveEntryDate", Order=5, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> EffectiveEntryDateValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("Expiration", Order=6, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> ExpirationValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("PaySettlementDate", Order=12, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> PaySettlementDateValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("RecordChangeDate", Order=14, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="BatchAchOrig_2" /> class.</para>
        /// </summary>
        public BatchAchOrig_2()
        {
