...
namespace AccountService
{
    ...
    [XmlTypeAttribute("PreferenceList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    ...
    public partial class PreferenceList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Preference> _preference;
        
        [XmlElementAttribute("Preference", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Preference> Preference
        {
            get
            {
                return _preference;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="PreferenceList" /> class.</para>
        /// </summary>
        public PreferenceList()
        {
            this._preference = new Collection<Preference>();
        }
    }
}
