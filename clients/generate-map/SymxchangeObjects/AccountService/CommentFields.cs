...
namespace AccountService
{
    ...
    [XmlTypeAttribute("CommentFields", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CommentFields", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class CommentFields
    {
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("EffectiveDate", Order=0, Form=XmlSchemaForm.Unqualified)]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("ExpirationDate", Order=1, Form=XmlSchemaForm.Unqualified)]
        ...
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the Text property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool TextValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<bool> Text
        {
            get
            {
                if (this.TextValueSpecified)
                {
            ...
            set
            {
                this.TextValue = value.GetValueOrDefault();
                this.TextValueSpecified = value.HasValue;
            }
        }
