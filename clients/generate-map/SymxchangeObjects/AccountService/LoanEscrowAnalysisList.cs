...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanEscrowAnalysisList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class LoanEscrowAnalysisList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanEscrowAnalysis> _loanEscrowAnalysis;
        
        [XmlElementAttribute("LoanEscrowAnalysis", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanEscrowAnalysis> LoanEscrowAnalysis
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanEscrowAnalysisList" /> class.</para>
        /// </summary>
        public LoanEscrowAnalysisList()
        {
            this._loanEscrowAnalysis = new Collection<LoanEscrowAnalysis>();
        }
    }
}
