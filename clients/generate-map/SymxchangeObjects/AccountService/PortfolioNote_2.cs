...
namespace AccountService
{
    ...
    [XmlTypeAttribute("PortfolioNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("PortfolioNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(PortfolioNoteFields_2))]
    public partial class PortfolioNote_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<PortfolioNoteText_2> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<PortfolioNoteText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="PortfolioNote_2" /> class.</para>
        /// </summary>
        public PortfolioNote_2()
        {
            this._text = new Collection<PortfolioNoteText_2>();
