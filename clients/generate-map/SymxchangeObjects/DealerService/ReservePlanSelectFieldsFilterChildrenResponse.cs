...
namespace DealerService
{
    ...
    [XmlTypeAttribute("ReservePlanSelectFieldsFilterChildrenResponse", Namespace="http://www.symxchange.generated.symitar.com/crud/dealer")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ReservePlanSelectFieldsFilterChildrenResponse
    {
        
        [XmlElementAttribute("ReservePlan", Order=0, Form=XmlSchemaForm.Unqualified)]
        public DealerService.ReservePlan ReservePlan { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ReservePlanSelectFieldsFilterChildrenResponse" /> class.</para>
        /// </summary>
        public ReservePlanSelectFieldsFilterChildrenResponse()
        {
