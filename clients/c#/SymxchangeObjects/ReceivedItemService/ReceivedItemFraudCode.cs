...
namespace ReceivedItemService
{
    ...
    [XmlTypeAttribute("ReceivedItemFraudCode", Namespace="http://www.symxchange.generated.symitar.com/crud/receiveditem/dto/retrieve", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("ReceivedItemFraudCode", Namespace="http://www.symxchange.generated.symitar.com/crud/receiveditem/dto/retrieve")]
    public partial class ReceivedItemFraudCode
    {
        ...
        public short FraudCodeValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the FraudCode property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool FraudCodeValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<short> FraudCode
        {
            get
            {
                if (this.FraudCodeValueSpecified)
                {
                    return this.FraudCodeValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.FraudCodeValue = value.GetValueOrDefault();
                this.FraudCodeValueSpecified = value.HasValue;
            }
        }
    }
}
