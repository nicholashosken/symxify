...
namespace ReceivedItemService
{
    ...
    [XmlTypeAttribute("ReceivedItem", Namespace="http://www.symxchange.generated.symitar.com/crud/receiveditem/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("ReceivedItem", Namespace="http://www.symxchange.generated.symitar.com/crud/receiveditem/dto/update")]
    [XmlIncludeAttribute(typeof(ReceivedItemFields_2))]
    public partial class ReceivedItem_2
    {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("ChargeOffDate", Order=13, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("CollectedDate", Order=14, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> CollectedDateValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("CollectionDate", Order=15, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> CollectionDateValue { get; set; }
        ...
        [XmlIgnoreAttribute()]
        private Collection<ReceivedItemDisposition_2> _disposition;
        
        [XmlElementAttribute("Disposition", Order=17, Form=XmlSchemaForm.Unqualified)]
        public Collection<ReceivedItemDisposition_2> Disposition
        {
            get
            {
                return _disposition;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ReceivedItem_2" /> class.</para>
        /// </summary>
        public ReceivedItem_2()
        {
            this._disposition = new Collection<ReceivedItemDisposition_2>();
            this._fraudCode = new Collection<ReceivedItemFraudCode_2>();
            this._fraudDescription = new Collection<ReceivedItemFraudDescription_2>();
            this._fraudSeverity = new Collection<ReceivedItemFraudSeverity_2>();
            this._fraudVendor = new Collection<ReceivedItemFraudVendor_2>();
            this._resubmitDate = new Collection<ReceivedItemResubmitDate_2>();
            this._returnDate = new Collection<ReceivedItemReturnDate_2>();
            this._returnReason = new Collection<ReceivedItemReturnReason_2>();
            this._tranSeqNumberAll = new Collection<ReceivedItemTranSeqNumberAll_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<ReceivedItemFraudCode_2> _fraudCode;
        
        [XmlElementAttribute("FraudCode", Order=18, Form=XmlSchemaForm.Unqualified)]
        public Collection<ReceivedItemFraudCode_2> FraudCode
        {
            get
            {
                return _fraudCode;
        ...
        [XmlIgnoreAttribute()]
        private Collection<ReceivedItemFraudDescription_2> _fraudDescription;
        
        [XmlElementAttribute("FraudDescription", Order=19, Form=XmlSchemaForm.Unqualified)]
        public Collection<ReceivedItemFraudDescription_2> FraudDescription
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ReceivedItemFraudSeverity_2> _fraudSeverity;
        
        [XmlElementAttribute("FraudSeverity", Order=20, Form=XmlSchemaForm.Unqualified)]
        public Collection<ReceivedItemFraudSeverity_2> FraudSeverity
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ReceivedItemFraudVendor_2> _fraudVendor;
        
        [XmlElementAttribute("FraudVendor", Order=21, Form=XmlSchemaForm.Unqualified)]
        public Collection<ReceivedItemFraudVendor_2> FraudVendor
        {
            get
            {
                return _fraudVendor;
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("GlobalSequenceDate", Order=23, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("PostDate", Order=43, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("RejectDate", Order=46, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> RejectDateValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("ReportDate", Order=47, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> ReportDateValue { get; set; }
        ...
        [XmlIgnoreAttribute()]
        private Collection<ReceivedItemResubmitDate_2> _resubmitDate;
        
        [XmlElementAttribute("ResubmitDate", Order=48, Form=XmlSchemaForm.Unqualified)]
        public Collection<ReceivedItemResubmitDate_2> ResubmitDate
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ReceivedItemReturnDate_2> _returnDate;
        
        [XmlElementAttribute("ReturnDate", Order=49, Form=XmlSchemaForm.Unqualified)]
        public Collection<ReceivedItemReturnDate_2> ReturnDate
        {
            get
            {
                return _returnDate;
        ...
        [XmlIgnoreAttribute()]
        private Collection<ReceivedItemReturnReason_2> _returnReason;
        
        [XmlElementAttribute("ReturnReason", Order=50, Form=XmlSchemaForm.Unqualified)]
        public Collection<ReceivedItemReturnReason_2> ReturnReason
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ReceivedItemTranSeqNumberAll_2> _tranSeqNumberAll;
        
        [XmlElementAttribute("TranSeqNumberAll", Order=55, Form=XmlSchemaForm.Unqualified)]
        public Collection<ReceivedItemTranSeqNumberAll_2> TranSeqNumberAll
        {
            get
            {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("VoidDate", Order=59, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
