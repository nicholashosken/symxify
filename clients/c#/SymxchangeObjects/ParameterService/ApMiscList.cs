...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("ApMiscList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ApMiscList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ApMisc> _apMisc;
        
        [XmlElementAttribute("ApMisc", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<ApMisc> ApMisc
        {
            get
            {
                return _apMisc;
        ...
        /// <summary>
        /// <para xml:lang="en">Gets a value indicating whether the ApMisc collection is empty.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        public bool ApMiscSpecified
        {
            get
            {
                return ((this.ApMisc != null) 
                            && (this.ApMisc.Count != 0));
            }
        }
        
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ApMiscList" /> class.</para>
        /// </summary>
        public ApMiscList()
        {
            this._apMisc = new Collection<ApMisc>();
        }
    }
}
