...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("PeriodicMtg", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("PeriodicMtg", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class PeriodicMtg
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<PeriodicMtgCollateralCodeList> _collateralCodeList;
        
        [XmlElementAttribute("CollateralCodeList", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<PeriodicMtgCollateralCodeList> CollateralCodeList
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="PeriodicMtg" /> class.</para>
        /// </summary>
        public PeriodicMtg()
        {
            this._collateralCodeList = new Collection<PeriodicMtgCollateralCodeList>();
            this._loanPurposeList = new Collection<PeriodicMtgLoanPurposeList>();
            this._loanTypeList = new Collection<PeriodicMtgLoanTypeList>();
        ...
        [XmlIgnoreAttribute()]
        private Collection<PeriodicMtgLoanPurposeList> _loanPurposeList;
        
        [XmlElementAttribute("LoanPurposeList", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<PeriodicMtgLoanPurposeList> LoanPurposeList
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<PeriodicMtgLoanTypeList> _loanTypeList;
        
        [XmlElementAttribute("LoanTypeList", Order=9, Form=XmlSchemaForm.Unqualified)]
        public Collection<PeriodicMtgLoanTypeList> LoanTypeList
        {
            get
            {
