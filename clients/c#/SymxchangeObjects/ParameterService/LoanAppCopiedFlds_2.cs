...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("LoanAppCopiedFlds", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanAppCopiedFlds", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(LoanAppCopiedFldsFields_2))]
    public partial class LoanAppCopiedFlds_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppCopiedFldsCopiedField_2> _copiedField;
        
        [XmlElementAttribute("CopiedField", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppCopiedFldsCopiedField_2> CopiedField
        {
            get
            {
                return _copiedField;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanAppCopiedFlds_2" /> class.</para>
        /// </summary>
        public LoanAppCopiedFlds_2()
        {
            this._copiedField = new Collection<LoanAppCopiedFldsCopiedField_2>();
            this._subField = new Collection<LoanAppCopiedFldsSubField_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<LoanAppCopiedFldsSubField_2> _subField;
        
        [XmlElementAttribute("SubField", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppCopiedFldsSubField_2> SubField
        {
            get
            {
                return _subField;
