...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("TcProduct", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("TcProduct", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(TcProductFields_2))]
    public partial class TcProduct_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<TcProductProductDescription_2> _productDescription;
        
        [XmlElementAttribute("ProductDescription", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<TcProductProductDescription_2> ProductDescription
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="TcProduct_2" /> class.</para>
        /// </summary>
        public TcProduct_2()
        {
            this._productDescription = new Collection<TcProductProductDescription_2>();
