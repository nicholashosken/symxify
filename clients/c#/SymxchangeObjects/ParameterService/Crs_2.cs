...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("Crs", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("Crs", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(CrsFields_2))]
    public partial class Crs_2
    {
        
        [XmlIgnoreAttribute()]
        private Collection<CrsBureauInfo_2> _bureauInfo;
        
        [XmlElementAttribute("BureauInfo", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsBureauInfo_2> BureauInfo
        {
            get
            {
                return _bureauInfo;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="Crs_2" /> class.</para>
        /// </summary>
        public Crs_2()
        {
            this._bureauInfo = new Collection<CrsBureauInfo_2>();
            this._chexSystemsVersion = new Collection<CrsChexSystemsVersion_2>();
            this._dpBureauInfo = new Collection<CrsDpBureauInfo_2>();
            this._dpPassword = new Collection<CrsDpPassword_2>();
            this._dpPasswordExpiration = new Collection<CrsDpPasswordExpiration_2>();
            this._dpSubscriberCode = new Collection<CrsDpSubscriberCode_2>();
            this._optionalFeatureCode = new Collection<CrsOptionalFeatureCode_2>();
            this._password = new Collection<CrsPassword_2>();
            this._passwordExpiration = new Collection<CrsPasswordExpiration_2>();
            this._responseFormat = new Collection<CrsResponseFormat_2>();
            this._riskModel = new Collection<CrsRiskModel_2>();
            this._scoreModel = new Collection<CrsScoreModel_2>();
            this._subscriberCode = new Collection<CrsSubscriberCode_2>();
            this._testEnvironment = new Collection<CrsTestEnvironment_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<CrsChexSystemsVersion_2> _chexSystemsVersion;
        
        [XmlElementAttribute("ChexSystemsVersion", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsChexSystemsVersion_2> ChexSystemsVersion
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsDpBureauInfo_2> _dpBureauInfo;
        
        [XmlElementAttribute("DpBureauInfo", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsDpBureauInfo_2> DpBureauInfo
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsDpPassword_2> _dpPassword;
        
        [XmlElementAttribute("DpPassword", Order=4, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsDpPassword_2> DpPassword
        {
            get
            {
                return _dpPassword;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsDpPasswordExpiration_2> _dpPasswordExpiration;
        
        [XmlElementAttribute("DpPasswordExpiration", Order=5, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsDpPasswordExpiration_2> DpPasswordExpiration
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsDpSubscriberCode_2> _dpSubscriberCode;
        
        [XmlElementAttribute("DpSubscriberCode", Order=6, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsDpSubscriberCode_2> DpSubscriberCode
        {
            get
            {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("InternetPasswordExpiration", Order=13, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> InternetPasswordExpirationValue { get; set; }
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsOptionalFeatureCode_2> _optionalFeatureCode;
        
        [XmlElementAttribute("OptionalFeatureCode", Order=18, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsOptionalFeatureCode_2> OptionalFeatureCode
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsPassword_2> _password;
        
        [XmlElementAttribute("Password", Order=19, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsPassword_2> Password
        {
            get
            {
                return _password;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsPasswordExpiration_2> _passwordExpiration;
        
        [XmlElementAttribute("PasswordExpiration", Order=20, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsPasswordExpiration_2> PasswordExpiration
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsResponseFormat_2> _responseFormat;
        
        [XmlElementAttribute("ResponseFormat", Order=21, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsResponseFormat_2> ResponseFormat
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsRiskModel_2> _riskModel;
        
        [XmlElementAttribute("RiskModel", Order=22, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsRiskModel_2> RiskModel
        {
            get
            {
                return _riskModel;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsScoreModel_2> _scoreModel;
        
        [XmlElementAttribute("ScoreModel", Order=23, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsScoreModel_2> ScoreModel
        {
            get
            {
                return _scoreModel;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsSubscriberCode_2> _subscriberCode;
        
        [XmlElementAttribute("SubscriberCode", Order=26, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsSubscriberCode_2> SubscriberCode
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CrsTestEnvironment_2> _testEnvironment;
        
        [XmlElementAttribute("TestEnvironment", Order=27, Form=XmlSchemaForm.Unqualified)]
        public Collection<CrsTestEnvironment_2> TestEnvironment
        {
            get
            {
