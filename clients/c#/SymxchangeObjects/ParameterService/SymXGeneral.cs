...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("SymXGeneral", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("SymXGeneral", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class SymXGeneral
    {
        
        [XmlIgnoreAttribute()]
        private Collection<SymXGeneralCustomSpecfile> _customSpecfile;
        
        [XmlElementAttribute("CustomSpecfile", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<SymXGeneralCustomSpecfile> CustomSpecfile
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="SymXGeneral" /> class.</para>
        /// </summary>
        public SymXGeneral()
        {
            this._customSpecfile = new Collection<SymXGeneralCustomSpecfile>();
            this._specfileLoadMethod = new Collection<SymXGeneralSpecfileLoadMethod>();
        ...
        [XmlIgnoreAttribute()]
        private Collection<SymXGeneralSpecfileLoadMethod> _specfileLoadMethod;
        
        [XmlElementAttribute("SpecfileLoadMethod", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<SymXGeneralSpecfileLoadMethod> SpecfileLoadMethod
        {
            get
            {
