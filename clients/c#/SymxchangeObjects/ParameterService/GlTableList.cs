...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("GlTableList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class GlTableList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<GlTable> _glTable;
        
        [XmlElementAttribute("GlTable", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<GlTable> GlTable
        {
            get
            {
                return _glTable;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="GlTableList" /> class.</para>
        /// </summary>
        public GlTableList()
        {
            this._glTable = new Collection<GlTable>();
        }
    }
}
