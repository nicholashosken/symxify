...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("TellerTranFee", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("TellerTranFee", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class TellerTranFee
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<TellerTranFeeRelCodeList> _relCodeList;
        
        [XmlElementAttribute("RelCodeList", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<TellerTranFeeRelCodeList> RelCodeList
        {
            get
            {
                return _relCodeList;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="TellerTranFee" /> class.</para>
        /// </summary>
        public TellerTranFee()
        {
            this._relCodeList = new Collection<TellerTranFeeRelCodeList>();
            this._relationFeeAmount = new Collection<TellerTranFeeRelationFeeAmount>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<TellerTranFeeRelationFeeAmount> _relationFeeAmount;
        
        [XmlElementAttribute("RelationFeeAmount", Order=4, Form=XmlSchemaForm.Unqualified)]
        public Collection<TellerTranFeeRelationFeeAmount> RelationFeeAmount
        {
            get
            {
