...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("CardWizList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CardWizList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardWiz> _cardWiz;
        
        [XmlElementAttribute("CardWiz", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardWiz> CardWiz
        {
            get
            {
                return _cardWiz;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CardWizList" /> class.</para>
        /// </summary>
        public CardWizList()
        {
            this._cardWiz = new Collection<CardWiz>();
        }
    }
}
