...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("AudioList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class AudioList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Audio> _audio;
        
        [XmlElementAttribute("Audio", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Audio> Audio
        {
            get
            {
                return _audio;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="AudioList" /> class.</para>
        /// </summary>
        public AudioList()
        {
            this._audio = new Collection<Audio>();
        }
    }
}
