...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("TptSelectFieldsRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class TptSelectFieldsRequest
    {
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("TptPrinter", Order=0, Form=XmlSchemaForm.Unqualified)]
        public short TptPrinterValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the TptPrinter property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool TptPrinterValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<short> TptPrinter
        {
            get
            {
                if (this.TptPrinterValueSpecified)
                {
                    return this.TptPrinterValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.TptPrinterValue = value.GetValueOrDefault();
                this.TptPrinterValueSpecified = value.HasValue;
            }
        }
        ...
        public ParameterService.TptSingleSelectableFields SelectableFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="TptSelectFieldsRequest" /> class.</para>
        /// </summary>
        public TptSelectFieldsRequest()
        {
