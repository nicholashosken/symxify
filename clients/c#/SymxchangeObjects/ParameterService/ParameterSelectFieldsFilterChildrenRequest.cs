...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("ParameterSelectFieldsFilterChildrenRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ParameterSelectFieldsFilterChildrenRequest
    {
        ...
        [XmlElementAttribute("SelectableFields", Order=2, Form=XmlSchemaForm.Unqualified)]
        public ParameterService.ParameterSelectableFields SelectableFields { get; set; }
        
        [XmlElementAttribute("ChildrenSearchFilter", Order=3, Form=XmlSchemaForm.Unqualified)]
        public ParameterService.ParameterChildrenFilter ChildrenSearchFilter { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ParameterSelectFieldsFilterChildrenRequest" /> class.</para>
        /// </summary>
        public ParameterSelectFieldsFilterChildrenRequest()
        {
