...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("Comment", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("Comment", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(CommentFields_2))]
    public partial class Comment_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CommentDataType_2> _dataType;
        
        [XmlElementAttribute("DataType", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentDataType_2> DataType
        {
            get
            {
                return _dataType;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="Comment_2" /> class.</para>
        /// </summary>
        public Comment_2()
        {
            this._dataType = new Collection<CommentDataType_2>();
            this._defaultChar = new Collection<CommentDefaultChar_2>();
            this._defaultNum = new Collection<CommentDefaultNum_2>();
            this._line = new Collection<CommentLine_2>();
            this._line1 = new Collection<CommentLine1_2>();
            this._line2 = new Collection<CommentLine2_2>();
            this._maxCode = new Collection<CommentMaxCode_2>();
            this._maxLength = new Collection<CommentMaxLength_2>();
            this._prompt = new Collection<CommentPrompt_2>();
            this._userHelp = new Collection<CommentUserHelp_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<CommentDefaultChar_2> _defaultChar;
        
        [XmlElementAttribute("DefaultChar", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentDefaultChar_2> DefaultChar
        {
            get
            {
                return _defaultChar;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CommentDefaultNum_2> _defaultNum;
        
        [XmlElementAttribute("DefaultNum", Order=4, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentDefaultNum_2> DefaultNum
        {
            get
            {
                return _defaultNum;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CommentLine_2> _line;
        
        [XmlElementAttribute("Line", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentLine_2> Line
        {
            get
            {
                return _line;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CommentLine1_2> _line1;
        
        [XmlElementAttribute("Line1", Order=9, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentLine1_2> Line1
        {
            get
            {
                return _line1;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CommentLine2_2> _line2;
        
        [XmlElementAttribute("Line2", Order=10, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentLine2_2> Line2
        {
            get
            {
                return _line2;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CommentMaxCode_2> _maxCode;
        
        [XmlElementAttribute("MaxCode", Order=11, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentMaxCode_2> MaxCode
        {
            get
            {
                return _maxCode;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CommentMaxLength_2> _maxLength;
        
        [XmlElementAttribute("MaxLength", Order=12, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentMaxLength_2> MaxLength
        {
            get
            {
                return _maxLength;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CommentPrompt_2> _prompt;
        
        [XmlElementAttribute("Prompt", Order=15, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentPrompt_2> Prompt
        {
            get
            {
                return _prompt;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CommentUserHelp_2> _userHelp;
        
        [XmlElementAttribute("UserHelp", Order=19, Form=XmlSchemaForm.Unqualified)]
        public Collection<CommentUserHelp_2> UserHelp
        {
            get
            {
                return _userHelp;
