...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("SymXInstanceSelectFieldsRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class SymXInstanceSelectFieldsRequest
    {
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("SymXInstanceInstanceId", Order=0, Form=XmlSchemaForm.Unqualified)]
        public short SymXInstanceInstanceIdValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the SymXInstanceInstanceId property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool SymXInstanceInstanceIdValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<short> SymXInstanceInstanceId
        {
            get
            {
                if (this.SymXInstanceInstanceIdValueSpecified)
                {
                    return this.SymXInstanceInstanceIdValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.SymXInstanceInstanceIdValue = value.GetValueOrDefault();
                this.SymXInstanceInstanceIdValueSpecified = value.HasValue;
            }
        }
        ...
        public ParameterService.SymXInstanceSingleSelectableFields SelectableFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="SymXInstanceSelectFieldsRequest" /> class.</para>
        /// </summary>
        public SymXInstanceSelectFieldsRequest()
        {
