...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("InsTypeList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class InsTypeList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<InsType> _insType;
        
        [XmlElementAttribute("InsType", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<InsType> InsType
        {
            get
            {
                return _insType;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="InsTypeList" /> class.</para>
        /// </summary>
        public InsTypeList()
        {
            this._insType = new Collection<InsType>();
        }
    }
}
