...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("CdmFields", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CdmFields", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class CdmFields
    {
        
        [XmlIgnoreAttribute()]
        private Collection<short> _cassDenom6DuressAuto1Notes;
        
        [XmlElementAttribute("CassDenom6DuressAuto1Notes", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<short> CassDenom6DuressAuto1Notes
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CdmFields" /> class.</para>
        /// </summary>
        public CdmFields()
        {
            this._cassDenom6DuressAuto1Notes = new Collection<short>();
            this._cassDenom6DuressAuto2Notes = new Collection<short>();
            this._cassDenom6DuressAuto3Notes = new Collection<short>();
            this._cassetteDenomAutomixNotes = new Collection<short>();
            this._cassetteDenomination = new Collection<short>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<short> _cassDenom6DuressAuto2Notes;
        
        [XmlElementAttribute("CassDenom6DuressAuto2Notes", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<short> CassDenom6DuressAuto2Notes
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<short> _cassDenom6DuressAuto3Notes;
        
        [XmlElementAttribute("CassDenom6DuressAuto3Notes", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<short> CassDenom6DuressAuto3Notes
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<short> _cassetteDenomAutomixNotes;
        
        [XmlElementAttribute("CassetteDenomAutomixNotes", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<short> CassetteDenomAutomixNotes
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<short> _cassetteDenomination;
        
        [XmlElementAttribute("CassetteDenomination", Order=4, Form=XmlSchemaForm.Unqualified)]
        public Collection<short> CassetteDenomination
        {
            get
            {
        ...
        public bool CdmValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the Cdm property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool CdmValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<bool> Cdm
        {
            get
            {
                if (this.CdmValueSpecified)
                {
            ...
            set
            {
                this.CdmValue = value.GetValueOrDefault();
                this.CdmValueSpecified = value.HasValue;
            }
        }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("CdmDuressDispAmt", Order=6, Form=XmlSchemaForm.Unqualified)]
        public bool CdmDuressDispAmtValue { get; set; }
        ...
        [XmlIgnoreAttribute()]
        public Nullable<bool> CdmDuressDispAmt
        {
            get
            {
        ...
        public bool ConsoleFileNameValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the ConsoleFileName property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool ConsoleFileNameValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<bool> ConsoleFileName
        {
            get
            {
                if (this.ConsoleFileNameValueSpecified)
                {
                    return this.ConsoleFileNameValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.ConsoleFileNameValue = value.GetValueOrDefault();
                this.ConsoleFileNameValueSpecified = value.HasValue;
            }
        }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("ConsoleFileNameExt", Order=9, Form=XmlSchemaForm.Unqualified)]
        public bool ConsoleFileNameExtValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the ConsoleFileNameExt property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool ConsoleFileNameExtValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<bool> ConsoleFileNameExt
        {
            get
            {
                if (this.ConsoleFileNameExtValueSpecified)
                {
                    return this.ConsoleFileNameExtValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.ConsoleFileNameExtValue = value.GetValueOrDefault();
                this.ConsoleFileNameExtValueSpecified = value.HasValue;
            }
        }
        ...
        public bool MachineTypeValue { get; set; }
        ...
        [XmlIgnoreAttribute()]
        public Nullable<bool> MachineType
        {
            get
            {
