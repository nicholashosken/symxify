...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("UpdateCdmByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateCdmByIdRequest
    {
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("CdmCdm", Order=0, Form=XmlSchemaForm.Unqualified)]
        public short CdmCdmValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the CdmCdm property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool CdmCdmValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<short> CdmCdm
        {
            get
            {
                if (this.CdmCdmValueSpecified)
                {
                    return this.CdmCdmValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.CdmCdmValue = value.GetValueOrDefault();
                this.CdmCdmValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("CdmFields", Order=3, Form=XmlSchemaForm.Unqualified)]
        public ParameterService.CdmFields_2 CdmFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateCdmByIdRequest" /> class.</para>
        /// </summary>
        public UpdateCdmByIdRequest()
        {
