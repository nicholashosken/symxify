...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("Disclosure", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("Disclosure", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(DisclosureFields_2))]
    public partial class Disclosure_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<DisclosureFedLine1_2> _fedLine1;
        
        [XmlElementAttribute("FedLine1", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<DisclosureFedLine1_2> FedLine1
        {
            get
            {
                return _fedLine1;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="Disclosure_2" /> class.</para>
        /// </summary>
        public Disclosure_2()
        {
            this._fedLine1 = new Collection<DisclosureFedLine1_2>();
            this._fedLine2 = new Collection<DisclosureFedLine2_2>();
            this._secLine1 = new Collection<DisclosureSecLine1_2>();
            this._secLine2 = new Collection<DisclosureSecLine2_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<DisclosureFedLine2_2> _fedLine2;
        
        [XmlElementAttribute("FedLine2", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<DisclosureFedLine2_2> FedLine2
        {
            get
            {
                return _fedLine2;
        ...
        [XmlIgnoreAttribute()]
        private Collection<DisclosureSecLine1_2> _secLine1;
        
        [XmlElementAttribute("SecLine1", Order=6, Form=XmlSchemaForm.Unqualified)]
        public Collection<DisclosureSecLine1_2> SecLine1
        {
            get
            {
                return _secLine1;
        ...
        [XmlIgnoreAttribute()]
        private Collection<DisclosureSecLine2_2> _secLine2;
        
        [XmlElementAttribute("SecLine2", Order=7, Form=XmlSchemaForm.Unqualified)]
        public Collection<DisclosureSecLine2_2> SecLine2
        {
            get
            {
                return _secLine2;
