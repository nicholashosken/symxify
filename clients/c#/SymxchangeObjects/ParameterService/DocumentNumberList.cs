...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("DocumentNumberList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class DocumentNumberList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<DocumentNumber> _documentNumber;
        
        [XmlElementAttribute("DocumentNumber", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<DocumentNumber> DocumentNumber
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Gets a value indicating whether the DocumentNumber collection is empty.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        public bool DocumentNumberSpecified
        {
            get
            {
                return ((this.DocumentNumber != null) 
                            && (this.DocumentNumber.Count != 0));
            }
        }
        
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="DocumentNumberList" /> class.</para>
        /// </summary>
        public DocumentNumberList()
        {
            this._documentNumber = new Collection<DocumentNumber>();
        }
    }
}
