...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("LoanAppMisc", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanAppMisc", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(LoanAppMiscFields_2))]
    public partial class LoanAppMisc_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppMiscAdditionalInfoHeader_2> _additionalInfoHeader;
        
        [XmlElementAttribute("AdditionalInfoHeader", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppMiscAdditionalInfoHeader_2> AdditionalInfoHeader
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanAppMisc_2" /> class.</para>
        /// </summary>
        public LoanAppMisc_2()
        {
            this._additionalInfoHeader = new Collection<LoanAppMiscAdditionalInfoHeader_2>();
            this._additionalInfoJustify = new Collection<LoanAppMiscAdditionalInfoJustify_2>();
            this._appTypeMaritalStatus = new Collection<LoanAppMiscAppTypeMaritalStatus_2>();
            this._creditUnionNameTransunion = new Collection<LoanAppMiscCreditUnionNameTransunion_2>();
            this._excludeTrdItemsTransunion = new Collection<LoanAppMiscExcludeTrdItemsTransunion_2>();
            this._nonMemberAccount = new Collection<LoanAppMiscNonMemberAccount_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<LoanAppMiscAdditionalInfoJustify_2> _additionalInfoJustify;
        
        [XmlElementAttribute("AdditionalInfoJustify", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppMiscAdditionalInfoJustify_2> AdditionalInfoJustify
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppMiscAppTypeMaritalStatus_2> _appTypeMaritalStatus;
        
        [XmlElementAttribute("AppTypeMaritalStatus", Order=5, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppMiscAppTypeMaritalStatus_2> AppTypeMaritalStatus
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppMiscCreditUnionNameTransunion_2> _creditUnionNameTransunion;
        
        [XmlElementAttribute("CreditUnionNameTransunion", Order=17, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppMiscCreditUnionNameTransunion_2> CreditUnionNameTransunion
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppMiscExcludeTrdItemsTransunion_2> _excludeTrdItemsTransunion;
        
        [XmlElementAttribute("ExcludeTrdItemsTransunion", Order=23, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppMiscExcludeTrdItemsTransunion_2> ExcludeTrdItemsTransunion
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppMiscNonMemberAccount_2> _nonMemberAccount;
        
        [XmlElementAttribute("NonMemberAccount", Order=32, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppMiscNonMemberAccount_2> NonMemberAccount
        {
            get
            {
