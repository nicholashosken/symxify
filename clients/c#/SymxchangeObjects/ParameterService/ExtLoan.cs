...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("ExtLoan", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("ExtLoan", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class ExtLoan
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ExtLoanTranCodeAdvDesc> _tranCodeAdvDesc;
        
        [XmlElementAttribute("TranCodeAdvDesc", Order=21, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExtLoanTranCodeAdvDesc> TranCodeAdvDesc
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ExtLoan" /> class.</para>
        /// </summary>
        public ExtLoan()
        {
            this._tranCodeAdvDesc = new Collection<ExtLoanTranCodeAdvDesc>();
            this._tranCodeAdvance = new Collection<ExtLoanTranCodeAdvance>();
            this._tranCodePayment = new Collection<ExtLoanTranCodePayment>();
            this._tranCodePmtDesc = new Collection<ExtLoanTranCodePmtDesc>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<ExtLoanTranCodeAdvance> _tranCodeAdvance;
        
        [XmlElementAttribute("TranCodeAdvance", Order=22, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExtLoanTranCodeAdvance> TranCodeAdvance
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ExtLoanTranCodePayment> _tranCodePayment;
        
        [XmlElementAttribute("TranCodePayment", Order=23, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExtLoanTranCodePayment> TranCodePayment
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ExtLoanTranCodePmtDesc> _tranCodePmtDesc;
        
        [XmlElementAttribute("TranCodePmtDesc", Order=24, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExtLoanTranCodePmtDesc> TranCodePmtDesc
        {
            get
            {
