...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("UpdateCtrBranchByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateCtrBranchByIdRequest
    {
        ...
        [XmlElementAttribute("CtrBranchLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int CtrBranchLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the CtrBranchLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool CtrBranchLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> CtrBranchLocator
        {
            get
            {
                if (this.CtrBranchLocatorValueSpecified)
                {
                    return this.CtrBranchLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.CtrBranchLocatorValue = value.GetValueOrDefault();
                this.CtrBranchLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("CtrBranchFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public FinrepService.CtrBranchFields_2 CtrBranchFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateCtrBranchByIdRequest" /> class.</para>
        /// </summary>
        public UpdateCtrBranchByIdRequest()
        {
