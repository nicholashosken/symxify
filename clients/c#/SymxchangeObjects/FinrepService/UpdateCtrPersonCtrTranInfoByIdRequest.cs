...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("UpdateCtrPersonCtrTranInfoByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateCtrPersonCtrTranInfoByIdRequest
    {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("CtrPersonCtrTranInfoLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int CtrPersonCtrTranInfoLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the CtrPersonCtrTranInfoLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool CtrPersonCtrTranInfoLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> CtrPersonCtrTranInfoLocator
        {
            get
            {
                if (this.CtrPersonCtrTranInfoLocatorValueSpecified)
                {
                    return this.CtrPersonCtrTranInfoLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.CtrPersonCtrTranInfoLocatorValue = value.GetValueOrDefault();
                this.CtrPersonCtrTranInfoLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("CtrPersonCtrTranInfoFields", Order=5, Form=XmlSchemaForm.Unqualified)]
        public FinrepService.CtrPersonCtrTranInfoFields_2 CtrPersonCtrTranInfoFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateCtrPersonCtrTranInfoByIdRequest" /> class.</para>
        /// </summary>
        public UpdateCtrPersonCtrTranInfoByIdRequest()
        {
