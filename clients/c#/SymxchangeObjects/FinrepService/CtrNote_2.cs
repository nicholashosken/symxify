...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("CtrNote", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CtrNote", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/update")]
    [XmlIncludeAttribute(typeof(CtrNoteFields_2))]
    public partial class CtrNote_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CtrNoteText_2> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<CtrNoteText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CtrNote_2" /> class.</para>
        /// </summary>
        public CtrNote_2()
        {
            this._text = new Collection<CtrNoteText_2>();
