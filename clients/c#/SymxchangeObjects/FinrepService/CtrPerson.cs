...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("CtrPerson", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CtrPerson", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/retrieve")]
    public partial class CtrPerson
    {
        ...
        [XmlElementAttribute("BirthDate", Order=1, Form=XmlSchemaForm.Unqualified, DataType="date")]
        ...
        [XmlElementAttribute("CtrPersonCtrTranInfoList", Order=6, Form=XmlSchemaForm.Unqualified)]
        public CtrPersonCtrTranInfoList CtrPersonCtrTranInfoList { get; set; }
        
        [XmlElementAttribute("DbaFirst", Order=7, Form=XmlSchemaForm.Unqualified)]
        public string DbaFirst { get; set; }
        
        [XmlElementAttribute("DbaLast", Order=8, Form=XmlSchemaForm.Unqualified)]
        public string DbaLast { get; set; }
        
        [XmlElementAttribute("DbaLongName", Order=9, Form=XmlSchemaForm.Unqualified)]
        public string DbaLongName { get; set; }
        
        [XmlElementAttribute("DbaMiddle", Order=10, Form=XmlSchemaForm.Unqualified)]
        public string DbaMiddle { get; set; }
        
        [XmlElementAttribute("DbaShortName", Order=11, Form=XmlSchemaForm.Unqualified)]
        public string DbaShortName { get; set; }
        
        [XmlElementAttribute("DbaSuffix", Order=12, Form=XmlSchemaForm.Unqualified)]
        public string DbaSuffix { get; set; }
        
        [XmlElementAttribute("Email", Order=13, Form=XmlSchemaForm.Unqualified)]
        public string Email { get; set; }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("EntityFlag", Order=14, Form=XmlSchemaForm.Unqualified)]
        ...
        [XmlElementAttribute("First", Order=15, Form=XmlSchemaForm.Unqualified)]
        public string First { get; set; }
        
        [XmlElementAttribute("Gender", Order=16, Form=XmlSchemaForm.Unqualified)]
        public string Gender { get; set; }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("Headquarters", Order=17, Form=XmlSchemaForm.Unqualified)]
        ...
        [XmlElementAttribute("IdIssueByCountry", Order=18, Form=XmlSchemaForm.Unqualified)]
        public string IdIssueByCountry { get; set; }
        
        [XmlElementAttribute("IdIssueByState", Order=19, Form=XmlSchemaForm.Unqualified)]
        public string IdIssueByState { get; set; }
        
        [XmlElementAttribute("IdNumber", Order=20, Form=XmlSchemaForm.Unqualified)]
        public string IdNumber { get; set; }
        
        [XmlElementAttribute("IdTypeOtherDesc", Order=21, Form=XmlSchemaForm.Unqualified)]
        public string IdTypeOtherDesc { get; set; }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("IdVerifyMethod", Order=22, Form=XmlSchemaForm.Unqualified)]
        ...
        [XmlElementAttribute("Last", Order=23, Form=XmlSchemaForm.Unqualified)]
        public string Last { get; set; }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("LastFmDate", Order=24, Form=XmlSchemaForm.Unqualified, DataType="date")]
        ...
        [XmlElementAttribute("LongName", Order=26, Form=XmlSchemaForm.Unqualified)]
        public string LongName { get; set; }
        
        [XmlElementAttribute("Middle", Order=27, Form=XmlSchemaForm.Unqualified)]
        public string Middle { get; set; }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("MultiTransFlag", Order=28, Form=XmlSchemaForm.Unqualified)]
        ...
        [XmlElementAttribute("NaicsCode", Order=29, Form=XmlSchemaForm.Unqualified)]
        public string NaicsCode { get; set; }
        
        [XmlElementAttribute("Occupation", Order=30, Form=XmlSchemaForm.Unqualified)]
        public string Occupation { get; set; }
        
        [XmlElementAttribute("Phone", Order=31, Form=XmlSchemaForm.Unqualified)]
        public string Phone { get; set; }
        
        [XmlElementAttribute("PhoneExt", Order=32, Form=XmlSchemaForm.Unqualified)]
        public string PhoneExt { get; set; }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("RecordChangeDate", Order=33, Form=XmlSchemaForm.Unqualified, DataType="date")]
        ...
        [XmlElementAttribute("ShortName", Order=34, Form=XmlSchemaForm.Unqualified)]
        public string ShortName { get; set; }
        
        [XmlElementAttribute("Ssn", Order=35, Form=XmlSchemaForm.Unqualified)]
        public string Ssn { get; set; }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("SsnTintype", Order=36, Form=XmlSchemaForm.Unqualified)]
        ...
        [XmlElementAttribute("State", Order=37, Form=XmlSchemaForm.Unqualified)]
        public string State { get; set; }
        
        [XmlElementAttribute("Suffix", Order=38, Form=XmlSchemaForm.Unqualified)]
        public string Suffix { get; set; }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("Type", Order=39, Form=XmlSchemaForm.Unqualified)]
        ...
        [XmlElementAttribute("ZipCode", Order=40, Form=XmlSchemaForm.Unqualified)]
        public string ZipCode { get; set; }
        
        [XmlElementAttribute("Version_1", Order=41, Form=XmlSchemaForm.Unqualified)]
        public FinrepService.VersionType Version1 { get; set; }
        
        [XmlIgnoreAttribute()]
        private Collection<XmlElement> _any;
        
        [XmlAnyElementAttribute(Order=42)]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CtrPerson" /> class.</para>
        /// </summary>
        public CtrPerson()
        {
