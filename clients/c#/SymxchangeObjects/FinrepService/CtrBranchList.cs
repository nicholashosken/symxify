...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("CtrBranchList", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CtrBranchList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CtrBranch> _ctrBranch;
        
        [XmlElementAttribute("CtrBranch", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CtrBranch> CtrBranch
        {
            get
            {
                return _ctrBranch;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CtrBranchList" /> class.</para>
        /// </summary>
        public CtrBranchList()
        {
            this._ctrBranch = new Collection<CtrBranch>();
        }
    }
}
