...
namespace TransactionsService
{
    ...
    [XmlTypeAttribute("GlCodeTypeItem", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions/dto", AnonymousType=true)]
    public enum GlCodeTypeItem
    {
