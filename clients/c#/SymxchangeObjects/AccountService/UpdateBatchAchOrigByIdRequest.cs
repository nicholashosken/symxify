...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateBatchAchOrigByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateBatchAchOrigByIdRequest
    {
        ...
        [XmlElementAttribute("BatchAchOrigLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int BatchAchOrigLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the BatchAchOrigLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool BatchAchOrigLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> BatchAchOrigLocator
        {
            get
            {
                if (this.BatchAchOrigLocatorValueSpecified)
                {
                    return this.BatchAchOrigLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.BatchAchOrigLocatorValue = value.GetValueOrDefault();
                this.BatchAchOrigLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("BatchAchOrigFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public AccountService.BatchAchOrigFields_2 BatchAchOrigFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateBatchAchOrigByIdRequest" /> class.</para>
        /// </summary>
        public UpdateBatchAchOrigByIdRequest()
        {
