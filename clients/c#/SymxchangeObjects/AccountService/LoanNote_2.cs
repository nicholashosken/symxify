...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(LoanNoteFields_2))]
    public partial class LoanNote_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanNoteText_2> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanNoteText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanNote_2" /> class.</para>
        /// </summary>
        public LoanNote_2()
        {
            this._text = new Collection<LoanNoteText_2>();
