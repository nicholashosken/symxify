...
namespace AccountService
{
    ...
    [XmlTypeAttribute("SiteCashOrderType", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("SiteCashOrderType", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class SiteCashOrderType
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<SiteCashOrderTypeCashOrderTypeCoinBag> _cashOrderTypeCoinBag;
        
        [XmlElementAttribute("CashOrderTypeCoinBag", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<SiteCashOrderTypeCashOrderTypeCoinBag> CashOrderTypeCoinBag
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="SiteCashOrderType" /> class.</para>
        /// </summary>
        public SiteCashOrderType()
        {
            this._cashOrderTypeCoinBag = new Collection<SiteCashOrderTypeCashOrderTypeCoinBag>();
            this._cashOrderTypeCoinRoll = new Collection<SiteCashOrderTypeCashOrderTypeCoinRoll>();
            this._cashOrderTypeComment = new Collection<SiteCashOrderTypeCashOrderTypeComment>();
            this._cashOrderTypeCurrFit = new Collection<SiteCashOrderTypeCashOrderTypeCurrFit>();
            this._cashOrderTypeCurrNew = new Collection<SiteCashOrderTypeCashOrderTypeCurrNew>();
            this._deliveryDays = new Collection<SiteCashOrderTypeDeliveryDays>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<SiteCashOrderTypeCashOrderTypeCoinRoll> _cashOrderTypeCoinRoll;
        
        [XmlElementAttribute("CashOrderTypeCoinRoll", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<SiteCashOrderTypeCashOrderTypeCoinRoll> CashOrderTypeCoinRoll
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<SiteCashOrderTypeCashOrderTypeComment> _cashOrderTypeComment;
        
        [XmlElementAttribute("CashOrderTypeComment", Order=4, Form=XmlSchemaForm.Unqualified)]
        public Collection<SiteCashOrderTypeCashOrderTypeComment> CashOrderTypeComment
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<SiteCashOrderTypeCashOrderTypeCurrFit> _cashOrderTypeCurrFit;
        
        [XmlElementAttribute("CashOrderTypeCurrFit", Order=5, Form=XmlSchemaForm.Unqualified)]
        public Collection<SiteCashOrderTypeCashOrderTypeCurrFit> CashOrderTypeCurrFit
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<SiteCashOrderTypeCashOrderTypeCurrNew> _cashOrderTypeCurrNew;
        
        [XmlElementAttribute("CashOrderTypeCurrNew", Order=6, Form=XmlSchemaForm.Unqualified)]
        public Collection<SiteCashOrderTypeCashOrderTypeCurrNew> CashOrderTypeCurrNew
        {
            get
            {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("CloseDate", Order=12, Form=XmlSchemaForm.Unqualified, DataType="date")]
        ...
        [XmlIgnoreAttribute()]
        private Collection<SiteCashOrderTypeDeliveryDays> _deliveryDays;
        
        [XmlElementAttribute("DeliveryDays", Order=14, Form=XmlSchemaForm.Unqualified)]
        public Collection<SiteCashOrderTypeDeliveryDays> DeliveryDays
        {
            get
            {
