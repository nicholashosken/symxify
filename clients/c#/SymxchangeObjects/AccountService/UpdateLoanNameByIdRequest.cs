...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateLoanNameByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateLoanNameByIdRequest
    {
        ...
        [XmlElementAttribute("LoanNameLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int LoanNameLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the LoanNameLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool LoanNameLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> LoanNameLocator
        {
            get
            {
                if (this.LoanNameLocatorValueSpecified)
                {
                    return this.LoanNameLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.LoanNameLocatorValue = value.GetValueOrDefault();
                this.LoanNameLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("LoanNameFields", Order=5, Form=XmlSchemaForm.Unqualified)]
        public AccountService.LoanNameFields_2 LoanNameFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateLoanNameByIdRequest" /> class.</para>
        /// </summary>
        public UpdateLoanNameByIdRequest()
        {
