...
namespace AccountService
{
    ...
    [XmlTypeAttribute("CpWorkCardNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CpWorkCardNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class CpWorkCardNote
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CpWorkCardNoteText> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<CpWorkCardNoteText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CpWorkCardNote" /> class.</para>
        /// </summary>
        public CpWorkCardNote()
        {
            this._text = new Collection<CpWorkCardNoteText>();
