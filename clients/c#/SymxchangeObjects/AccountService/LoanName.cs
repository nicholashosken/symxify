...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanName", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanName", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class LoanName
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanNameIdentDocFlag> _identDocFlag;
        
        [XmlElementAttribute("IdentDocFlag", Order=58, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanNameIdentDocFlag> IdentDocFlag
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanName" /> class.</para>
        /// </summary>
        public LoanName()
        {
            this._identDocFlag = new Collection<LoanNameIdentDocFlag>();
            this._identIdDescription = new Collection<LoanNameIdentIdDescription>();
            this._identIdExpireDate = new Collection<LoanNameIdentIdExpireDate>();
            this._identIdIssueDate = new Collection<LoanNameIdentIdIssueDate>();
            this._identIdNumber = new Collection<LoanNameIdentIdNumber>();
            this._identIdType = new Collection<LoanNameIdentIdType>();
            this._identIdVerifyDate = new Collection<LoanNameIdentIdVerifyDate>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<LoanNameIdentIdDescription> _identIdDescription;
        
        [XmlElementAttribute("IdentIdDescription", Order=59, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanNameIdentIdDescription> IdentIdDescription
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanNameIdentIdExpireDate> _identIdExpireDate;
        
        [XmlElementAttribute("IdentIdExpireDate", Order=60, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanNameIdentIdExpireDate> IdentIdExpireDate
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanNameIdentIdIssueDate> _identIdIssueDate;
        
        [XmlElementAttribute("IdentIdIssueDate", Order=61, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanNameIdentIdIssueDate> IdentIdIssueDate
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanNameIdentIdNumber> _identIdNumber;
        
        [XmlElementAttribute("IdentIdNumber", Order=62, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanNameIdentIdNumber> IdentIdNumber
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanNameIdentIdType> _identIdType;
        
        [XmlElementAttribute("IdentIdType", Order=63, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanNameIdentIdType> IdentIdType
        {
            get
            {
                return _identIdType;
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanNameIdentIdVerifyDate> _identIdVerifyDate;
        
        [XmlElementAttribute("IdentIdVerifyDate", Order=64, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanNameIdentIdVerifyDate> IdentIdVerifyDate
        {
            get
            {
