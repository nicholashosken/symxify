...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanAppNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanAppNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class LoanAppNote
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppNoteText> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppNoteText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanAppNote" /> class.</para>
        /// </summary>
        public LoanAppNote()
        {
            this._text = new Collection<LoanAppNoteText>();
