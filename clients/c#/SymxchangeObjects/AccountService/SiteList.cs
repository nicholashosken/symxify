...
namespace AccountService
{
    ...
    [XmlTypeAttribute("SiteList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    ...
    public partial class SiteList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Site> _site;
        
        [XmlElementAttribute("Site", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Site> Site
        {
            get
            {
                return _site;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="SiteList" /> class.</para>
        /// </summary>
        public SiteList()
        {
            this._site = new Collection<Site>();
        }
    }
}
