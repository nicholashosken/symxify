...
namespace AccountService
{
    ...
    [XmlTypeAttribute("PortfolioList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    ...
    public partial class PortfolioList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Portfolio> _portfolio;
        
        [XmlElementAttribute("Portfolio", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Portfolio> Portfolio
        {
            get
            {
                return _portfolio;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="PortfolioList" /> class.</para>
        /// </summary>
        public PortfolioList()
        {
            this._portfolio = new Collection<Portfolio>();
        }
    }
}
