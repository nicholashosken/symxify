...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdatePortfolioTrackingByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdatePortfolioTrackingByIdRequest
    {
        ...
        [XmlElementAttribute("PortfolioTrackingLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int PortfolioTrackingLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the PortfolioTrackingLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool PortfolioTrackingLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> PortfolioTrackingLocator
        {
            get
            {
                if (this.PortfolioTrackingLocatorValueSpecified)
                {
                    return this.PortfolioTrackingLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.PortfolioTrackingLocatorValue = value.GetValueOrDefault();
                this.PortfolioTrackingLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("PortfolioTrackingFields", Order=5, Form=XmlSchemaForm.Unqualified)]
        public AccountService.PortfolioTrackingFields_2 PortfolioTrackingFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdatePortfolioTrackingByIdRequest" /> class.</para>
        /// </summary>
        public UpdatePortfolioTrackingByIdRequest()
        {
