...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdatePortfolioHoldByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdatePortfolioHoldByIdRequest
    {
        ...
        [XmlElementAttribute("PortfolioHoldLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int PortfolioHoldLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the PortfolioHoldLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool PortfolioHoldLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> PortfolioHoldLocator
        {
            get
            {
                if (this.PortfolioHoldLocatorValueSpecified)
                {
                    return this.PortfolioHoldLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.PortfolioHoldLocatorValue = value.GetValueOrDefault();
                this.PortfolioHoldLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("PortfolioHoldFields", Order=5, Form=XmlSchemaForm.Unqualified)]
        public AccountService.PortfolioHoldFields_2 PortfolioHoldFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdatePortfolioHoldByIdRequest" /> class.</para>
        /// </summary>
        public UpdatePortfolioHoldByIdRequest()
        {
