...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanPledgeName", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanPledgeName", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class LoanPledgeName
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanPledgeNameIdentDocFlag> _identDocFlag;
        
        [XmlElementAttribute("IdentDocFlag", Order=58, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanPledgeNameIdentDocFlag> IdentDocFlag
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanPledgeName" /> class.</para>
        /// </summary>
        public LoanPledgeName()
        {
            this._identDocFlag = new Collection<LoanPledgeNameIdentDocFlag>();
            this._identIdDescription = new Collection<LoanPledgeNameIdentIdDescription>();
            this._identIdExpireDate = new Collection<LoanPledgeNameIdentIdExpireDate>();
            this._identIdIssueDate = new Collection<LoanPledgeNameIdentIdIssueDate>();
            this._identIdNumber = new Collection<LoanPledgeNameIdentIdNumber>();
            this._identIdType = new Collection<LoanPledgeNameIdentIdType>();
            this._identIdVerifyDate = new Collection<LoanPledgeNameIdentIdVerifyDate>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<LoanPledgeNameIdentIdDescription> _identIdDescription;
        
        [XmlElementAttribute("IdentIdDescription", Order=59, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanPledgeNameIdentIdDescription> IdentIdDescription
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanPledgeNameIdentIdExpireDate> _identIdExpireDate;
        
        [XmlElementAttribute("IdentIdExpireDate", Order=60, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanPledgeNameIdentIdExpireDate> IdentIdExpireDate
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanPledgeNameIdentIdIssueDate> _identIdIssueDate;
        
        [XmlElementAttribute("IdentIdIssueDate", Order=61, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanPledgeNameIdentIdIssueDate> IdentIdIssueDate
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanPledgeNameIdentIdNumber> _identIdNumber;
        
        [XmlElementAttribute("IdentIdNumber", Order=62, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanPledgeNameIdentIdNumber> IdentIdNumber
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanPledgeNameIdentIdType> _identIdType;
        
        [XmlElementAttribute("IdentIdType", Order=63, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanPledgeNameIdentIdType> IdentIdType
        {
            get
            {
                return _identIdType;
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanPledgeNameIdentIdVerifyDate> _identIdVerifyDate;
        
        [XmlElementAttribute("IdentIdVerifyDate", Order=64, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanPledgeNameIdentIdVerifyDate> IdentIdVerifyDate
        {
            get
            {
