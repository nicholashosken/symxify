...
namespace AccountService
{
    ...
    [XmlTypeAttribute("ShareNameList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ShareNameList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareName> _shareName;
        
        [XmlElementAttribute("ShareName", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareName> ShareName
        {
            get
            {
                return _shareName;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ShareNameList" /> class.</para>
        /// </summary>
        public ShareNameList()
        {
            this._shareName = new Collection<ShareName>();
        }
    }
}
