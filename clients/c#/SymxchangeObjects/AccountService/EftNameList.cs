...
namespace AccountService
{
    ...
    [XmlTypeAttribute("EftNameList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class EftNameList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<EftName> _eftName;
        
        [XmlElementAttribute("EftName", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<EftName> EftName
        {
            get
            {
                return _eftName;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="EftNameList" /> class.</para>
        /// </summary>
        public EftNameList()
        {
            this._eftName = new Collection<EftName>();
        }
    }
}
