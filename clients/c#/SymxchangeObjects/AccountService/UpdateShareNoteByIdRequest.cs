...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateShareNoteByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateShareNoteByIdRequest
    {
        ...
        [XmlElementAttribute("ShareNoteLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int ShareNoteLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the ShareNoteLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool ShareNoteLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> ShareNoteLocator
        {
            get
            {
                if (this.ShareNoteLocatorValueSpecified)
                {
                    return this.ShareNoteLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.ShareNoteLocatorValue = value.GetValueOrDefault();
                this.ShareNoteLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("ShareNoteFields", Order=5, Form=XmlSchemaForm.Unqualified)]
        public AccountService.ShareNoteFields_2 ShareNoteFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateShareNoteByIdRequest" /> class.</para>
        /// </summary>
        public UpdateShareNoteByIdRequest()
        {
