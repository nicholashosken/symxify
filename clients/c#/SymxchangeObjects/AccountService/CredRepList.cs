...
namespace AccountService
{
    ...
    [XmlTypeAttribute("CredRepList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CredRepList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CredRep> _credRep;
        
        [XmlElementAttribute("CredRep", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CredRep> CredRep
        {
            get
            {
                return _credRep;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CredRepList" /> class.</para>
        /// </summary>
        public CredRepList()
        {
            this._credRep = new Collection<CredRep>();
        }
    }
}
