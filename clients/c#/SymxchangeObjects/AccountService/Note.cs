...
namespace AccountService
{
    ...
    [XmlTypeAttribute("Note", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("Note", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class Note
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<NoteText> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<NoteText> Text
        {
            get
            {
                return _text;
        ...
        public Note()
        {
            this._text = new Collection<NoteText>();
