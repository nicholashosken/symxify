...
namespace PowerOnService
{
    ...
    [XmlTypeAttribute("UserRate", Namespace="http://www.symxchange.generated.symitar.com/noncrud/poweron/dto")]
    ...
    public partial class UserRate
    {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UserRate" /> class.</para>
        /// </summary>
        public UserRate()
        {
