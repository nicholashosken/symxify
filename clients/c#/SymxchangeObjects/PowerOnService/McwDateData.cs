...
namespace PowerOnService
{
    ...
    [XmlTypeAttribute("MCWDateData", Namespace="http://www.symxchange.generated.symitar.com/noncrud/poweron/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class McwDateData
    {
        ...
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("Value", Order=1, Form=XmlSchemaForm.Unqualified, DataType="date")]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="McwDateData" /> class.</para>
        /// </summary>
        public McwDateData()
        {
