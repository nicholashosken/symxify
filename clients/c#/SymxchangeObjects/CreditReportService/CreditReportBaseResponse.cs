...
namespace CreditReportService
{
    ...
    [XmlTypeAttribute("CreditReportBaseResponse", Namespace="http://www.symxchange.generated.symitar.com/noncrud/creditreport/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlIncludeAttribute(typeof(CreditReportResponse))]
    public partial class CreditReportBaseResponse
    {
        
        [XmlElementAttribute("Status", Order=0, Form=XmlSchemaForm.Unqualified)]
        public CreditReportService.Status Status { get; set; }
