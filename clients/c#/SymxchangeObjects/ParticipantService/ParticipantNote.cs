...
namespace ParticipantService
{
    ...
    [XmlTypeAttribute("ParticipantNote", Namespace="http://www.symxchange.generated.symitar.com/crud/participant/dto/retrieve")]
    ...
    public partial class ParticipantNote
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ParticipantNoteText> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<ParticipantNoteText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ParticipantNote" /> class.</para>
        /// </summary>
        public ParticipantNote()
        {
            this._text = new Collection<ParticipantNoteText>();
