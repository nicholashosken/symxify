...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("InvoiceFilter", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable/dto/retrieve")]
    ...
    public partial class InvoiceFilter
    {
        ...
        [XmlElementAttribute("InvoiceChildrenFilter", Order=1, Form=XmlSchemaForm.Unqualified)]
        public InvoiceChildrenFilter InvoiceChildrenFilter { get; set; }
    }
}
