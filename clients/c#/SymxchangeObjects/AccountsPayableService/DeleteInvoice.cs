...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("deleteInvoice", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("deleteInvoice", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable")]
    public partial class DeleteInvoice
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public DeleteInvoiceRequest Request { get; set; }
    }
}
