...
namespace GeneralLedgerService
{
    ...
    [XmlTypeAttribute("GlHistoryList", Namespace="http://www.symxchange.generated.symitar.com/crud/generalledger/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class GlHistoryList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<GlHistory> _glHistory;
        
        [XmlElementAttribute("GlHistory", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<GlHistory> GlHistory
        {
            get
            {
                return _glHistory;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="GlHistoryList" /> class.</para>
        /// </summary>
        public GlHistoryList()
        {
            this._glHistory = new Collection<GlHistory>();
        }
    }
}
