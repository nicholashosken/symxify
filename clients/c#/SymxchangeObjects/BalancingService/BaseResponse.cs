...
namespace BalancingService
{
    ...
    [XmlIncludeAttribute(typeof(BalancingService.CashValueAdjustResponse))]
    [XmlIncludeAttribute(typeof(BalancingService.CashValueReportResponse))]
    [XmlIncludeAttribute(typeof(BalancingService.CheckDisbursedReportResponse))]
    [XmlIncludeAttribute(typeof(BalancingService.ResetCashValueBalancesResponse))]
    [XmlIncludeAttribute(typeof(BalancingService.ResetDepositBalancesResponse))]
    [XmlIncludeAttribute(typeof(BalancingService.ResetSecondPartyCheckBalancesResponse))]
    [XmlIncludeAttribute(typeof(BalancingService.SecondPartyCheckAdjustResponse))]
    [XmlIncludeAttribute(typeof(BalancingService.VerifyDepositReportResponse))]
