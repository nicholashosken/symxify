...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireBeneficiaryAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireBeneficiaryAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireBeneficiaryAdvFields_2))]
    public partial class WireBeneficiaryAdv_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireBeneficiaryAdvText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireBeneficiaryAdvText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireBeneficiaryAdv_2" /> class.</para>
        /// </summary>
        public WireBeneficiaryAdv_2()
        {
            this._text = new Collection<WireBeneficiaryAdvText_2>();
