...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireReceiverFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireReceiverFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireReceiverFiInfoFields_2))]
    public partial class WireReceiverFiInfo_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireReceiverFiInfoText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireReceiverFiInfoText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireReceiverFiInfo_2" /> class.</para>
        /// </summary>
        public WireReceiverFiInfo_2()
        {
            this._text = new Collection<WireReceiverFiInfoText_2>();
