...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireServiceMessage", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireServiceMessage", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireServiceMessageFields_2))]
    public partial class WireServiceMessage_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireServiceMessageText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireServiceMessageText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireServiceMessage_2" /> class.</para>
        /// </summary>
        public WireServiceMessage_2()
        {
            this._text = new Collection<WireServiceMessageText_2>();
