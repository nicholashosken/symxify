...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireUscAuditInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireUscAuditInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireUscAuditInfo
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireUscAuditInfoText> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireUscAuditInfoText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireUscAuditInfo" /> class.</para>
        /// </summary>
        public WireUscAuditInfo()
        {
            this._text = new Collection<WireUscAuditInfoText>();
