...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireOfacDetails", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireOfacDetails", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireOfacDetailsFields_2))]
    public partial class WireOfacDetails_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireOfacDetailsText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireOfacDetailsText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireOfacDetails_2" /> class.</para>
        /// </summary>
        public WireOfacDetails_2()
        {
            this._text = new Collection<WireOfacDetailsText_2>();
