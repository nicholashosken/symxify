...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireBeneficiaryInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireBeneficiaryInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireBeneficiaryInfoFields_2))]
    public partial class WireBeneficiaryInfo_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireBeneficiaryInfoText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireBeneficiaryInfoText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireBeneficiaryInfo_2" /> class.</para>
        /// </summary>
        public WireBeneficiaryInfo_2()
        {
            this._text = new Collection<WireBeneficiaryInfoText_2>();
