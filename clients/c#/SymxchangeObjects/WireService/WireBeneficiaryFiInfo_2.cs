...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireBeneficiaryFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireBeneficiaryFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireBeneficiaryFiInfoFields_2))]
    public partial class WireBeneficiaryFiInfo_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireBeneficiaryFiInfoText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireBeneficiaryFiInfoText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireBeneficiaryFiInfo_2" /> class.</para>
        /// </summary>
        public WireBeneficiaryFiInfo_2()
        {
            this._text = new Collection<WireBeneficiaryFiInfoText_2>();
