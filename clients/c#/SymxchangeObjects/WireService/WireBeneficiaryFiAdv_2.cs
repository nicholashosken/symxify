...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireBeneficiaryFiAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireBeneficiaryFiAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireBeneficiaryFiAdvFields_2))]
    public partial class WireBeneficiaryFiAdv_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireBeneficiaryFiAdvText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireBeneficiaryFiAdvText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireBeneficiaryFiAdv_2" /> class.</para>
        /// </summary>
        public WireBeneficiaryFiAdv_2()
        {
            this._text = new Collection<WireBeneficiaryFiAdvText_2>();
