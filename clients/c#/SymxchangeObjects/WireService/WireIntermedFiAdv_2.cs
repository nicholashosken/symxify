...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireIntermedFiAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireIntermedFiAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireIntermedFiAdvFields_2))]
    public partial class WireIntermedFiAdv_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireIntermedFiAdvText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireIntermedFiAdvText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireIntermedFiAdv_2" /> class.</para>
        /// </summary>
        public WireIntermedFiAdv_2()
        {
            this._text = new Collection<WireIntermedFiAdvText_2>();
