...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireBeneficiaryFiAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireBeneficiaryFiAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireBeneficiaryFiAdv
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireBeneficiaryFiAdvText> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireBeneficiaryFiAdvText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireBeneficiaryFiAdv" /> class.</para>
        /// </summary>
        public WireBeneficiaryFiAdv()
        {
            this._text = new Collection<WireBeneficiaryFiAdvText>();
