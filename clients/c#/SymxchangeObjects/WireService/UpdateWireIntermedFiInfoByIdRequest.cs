...
namespace WireService
{
    ...
    [XmlTypeAttribute("UpdateWireIntermedFiInfoByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/wire")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateWireIntermedFiInfoByIdRequest
    {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("WireIntermedFiInfoLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int WireIntermedFiInfoLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the WireIntermedFiInfoLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool WireIntermedFiInfoLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> WireIntermedFiInfoLocator
        {
            get
            {
                if (this.WireIntermedFiInfoLocatorValueSpecified)
                {
                    return this.WireIntermedFiInfoLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.WireIntermedFiInfoLocatorValue = value.GetValueOrDefault();
                this.WireIntermedFiInfoLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("WireIntermedFiInfoFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public WireService.WireIntermedFiInfoFields_2 WireIntermedFiInfoFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateWireIntermedFiInfoByIdRequest" /> class.</para>
        /// </summary>
        public UpdateWireIntermedFiInfoByIdRequest()
        {
