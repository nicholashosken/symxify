...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("CtrNoteList", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CtrNoteList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CtrNote> _ctrNote;
        
        [XmlElementAttribute("CtrNote", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CtrNote> CtrNote
        {
            get
            {
                return _ctrNote;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CtrNoteList" /> class.</para>
        /// </summary>
        public CtrNoteList()
        {
            this._ctrNote = new Collection<CtrNote>();
        }
    }
}
