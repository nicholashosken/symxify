...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("CtrNote", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CtrNote", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep/dto/retrieve")]
    public partial class CtrNote
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CtrNoteText> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<CtrNoteText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CtrNote" /> class.</para>
        /// </summary>
        public CtrNote()
        {
            this._text = new Collection<CtrNoteText>();
