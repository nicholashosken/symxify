...
namespace FinrepService
{
    ...
    [XmlTypeAttribute("UpdateCtrForeignByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/finrep")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateCtrForeignByIdRequest
    {
        ...
        [XmlElementAttribute("CtrForeignLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int CtrForeignLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the CtrForeignLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool CtrForeignLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> CtrForeignLocator
        {
            get
            {
                if (this.CtrForeignLocatorValueSpecified)
                {
                    return this.CtrForeignLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.CtrForeignLocatorValue = value.GetValueOrDefault();
                this.CtrForeignLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("CtrForeignFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public FinrepService.CtrForeignFields_2 CtrForeignFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateCtrForeignByIdRequest" /> class.</para>
        /// </summary>
        public UpdateCtrForeignByIdRequest()
        {
