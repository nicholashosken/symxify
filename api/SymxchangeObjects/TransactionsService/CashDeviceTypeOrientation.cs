...
namespace TransactionsService
{
    ...
    [XmlTypeAttribute("CashDeviceTypeOrientation", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions/dto", AnonymousType=true)]
    public enum CashDeviceTypeOrientation
    {
