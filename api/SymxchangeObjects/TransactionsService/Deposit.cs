...
namespace TransactionsService
{
    ...
    [XmlTypeAttribute("deposit", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("deposit", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions")]
    public partial class Deposit
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public TransactionsService.ShareDepositRequest Request { get; set; }
    }
}
