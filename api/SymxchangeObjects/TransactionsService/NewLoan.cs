...
namespace TransactionsService
{
    ...
    [XmlTypeAttribute("newLoan", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("newLoan", Namespace="http://www.symxchange.generated.symitar.com/noncrud/transactions")]
    public partial class NewLoan
    {
        
        [XmlElementAttribute("Request", Order=0, Form=XmlSchemaForm.Unqualified)]
        public TransactionsService.NewLoanRequest Request { get; set; }
    }
}
