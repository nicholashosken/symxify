...
namespace ProjectionService
{
    ...
    [XmlTypeAttribute("CalculateLoanAmountRequest", Namespace="http://www.symxchange.generated.symitar.com/noncrud/projection/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CalculateLoanAmountRequest : LoanProjectionBaseRequest
    {
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("MaturityDate", Order=0, Form=XmlSchemaForm.Unqualified, DataType="date")]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CalculateLoanAmountRequest" /> class.</para>
        /// </summary>
        public CalculateLoanAmountRequest()
        {
