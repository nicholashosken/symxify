...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("DebtRatioList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class DebtRatioList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<DebtRatio> _debtRatio;
        
        [XmlElementAttribute("DebtRatio", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<DebtRatio> DebtRatio
        {
            get
            {
                return _debtRatio;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="DebtRatioList" /> class.</para>
        /// </summary>
        public DebtRatioList()
        {
            this._debtRatio = new Collection<DebtRatio>();
        }
    }
}
