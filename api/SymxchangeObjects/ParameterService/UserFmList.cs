...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("UserFmList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UserFmList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<UserFm> _userFm;
        
        [XmlElementAttribute("UserFm", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<UserFm> UserFm
        {
            get
            {
                return _userFm;
        ...
        /// <summary>
        /// <para xml:lang="en">Gets a value indicating whether the UserFm collection is empty.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        public bool UserFmSpecified
        {
            get
            {
                return ((this.UserFm != null) 
                            && (this.UserFm.Count != 0));
            }
        }
        
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UserFmList" /> class.</para>
        /// </summary>
        public UserFmList()
        {
            this._userFm = new Collection<UserFm>();
        }
    }
}
