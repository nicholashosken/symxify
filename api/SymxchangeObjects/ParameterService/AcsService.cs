...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("AcsService", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("AcsService", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class AcsService
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceAction> _action;
        
        [XmlElementAttribute("Action", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceAction> Action
        {
            get
            {
                return _action;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="AcsService" /> class.</para>
        /// </summary>
        public AcsService()
        {
            this._action = new Collection<AcsServiceAction>();
            this._actionCreateRecord = new Collection<AcsServiceActionCreateRecord>();
            this._actionCreateText = new Collection<AcsServiceActionCreateText>();
            this._actionCreateType = new Collection<AcsServiceActionCreateType>();
            this._compDataType = new Collection<AcsServiceCompDataType>();
            this._compareNum = new Collection<AcsServiceCompareNum>();
            this._comparisonMethod = new Collection<AcsServiceComparisonMethod>();
            this._comparisonValue = new Collection<AcsServiceComparisonValue>();
            this._criteria12 = new Collection<AcsServiceCriteria12>();
            this._criteriaOperator = new Collection<AcsServiceCriteriaOperator>();
            this._menuOption = new Collection<AcsServiceMenuOption>();
            this._script = new Collection<AcsServiceScript>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceActionCreateRecord> _actionCreateRecord;
        
        [XmlElementAttribute("ActionCreateRecord", Order=4, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceActionCreateRecord> ActionCreateRecord
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceActionCreateText> _actionCreateText;
        
        [XmlElementAttribute("ActionCreateText", Order=5, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceActionCreateText> ActionCreateText
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceActionCreateType> _actionCreateType;
        
        [XmlElementAttribute("ActionCreateType", Order=6, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceActionCreateType> ActionCreateType
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceCompDataType> _compDataType;
        
        [XmlElementAttribute("CompDataType", Order=7, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceCompDataType> CompDataType
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceCompareNum> _compareNum;
        
        [XmlElementAttribute("CompareNum", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceCompareNum> CompareNum
        {
            get
            {
                return _compareNum;
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceComparisonMethod> _comparisonMethod;
        
        [XmlElementAttribute("ComparisonMethod", Order=9, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceComparisonMethod> ComparisonMethod
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceComparisonValue> _comparisonValue;
        
        [XmlElementAttribute("ComparisonValue", Order=10, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceComparisonValue> ComparisonValue
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceCriteria12> _criteria12;
        
        [XmlElementAttribute("Criteria12", Order=12, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceCriteria12> Criteria12
        {
            get
            {
                return _criteria12;
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceCriteriaOperator> _criteriaOperator;
        
        [XmlElementAttribute("CriteriaOperator", Order=13, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceCriteriaOperator> CriteriaOperator
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceMenuOption> _menuOption;
        
        [XmlElementAttribute("MenuOption", Order=17, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceMenuOption> MenuOption
        {
            get
            {
                return _menuOption;
        ...
        [XmlIgnoreAttribute()]
        private Collection<AcsServiceScript> _script;
        
        [XmlElementAttribute("Script", Order=20, Form=XmlSchemaForm.Unqualified)]
        public Collection<AcsServiceScript> Script
        {
            get
            {
                return _script;
