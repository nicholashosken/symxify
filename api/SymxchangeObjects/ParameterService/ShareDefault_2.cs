...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("ShareDefault", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("ShareDefault", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(ShareDefaultFields_2))]
    public partial class ShareDefault_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareDefaultAuthFeeOption_2> _authFeeOption;
        
        [XmlElementAttribute("AuthFeeOption", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareDefaultAuthFeeOption_2> AuthFeeOption
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ShareDefault_2" /> class.</para>
        /// </summary>
        public ShareDefault_2()
        {
            this._authFeeOption = new Collection<ShareDefaultAuthFeeOption_2>();
            this._odtAuthFeeSrcCodeList = new Collection<ShareDefaultOdtAuthFeeSrcCodeList_2>();
            this._service = new Collection<ShareDefaultService_2>();
            this._warningCode = new Collection<ShareDefaultWarningCode_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("BumpEffectiveDate", Order=3, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("BumpExpirationDate", Order=4, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("DividendRatePeriodDate", Order=26, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("MaturityDate", Order=34, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareDefaultOdtAuthFeeSrcCodeList_2> _odtAuthFeeSrcCodeList;
        
        [XmlElementAttribute("OdtAuthFeeSrcCodeList", Order=44, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareDefaultOdtAuthFeeSrcCodeList_2> OdtAuthFeeSrcCodeList
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareDefaultService_2> _service;
        
        [XmlElementAttribute("Service", Order=56, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareDefaultService_2> Service
        {
            get
            {
                return _service;
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("UserDate1", Order=75, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("UserDate2", Order=76, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareDefaultWarningCode_2> _warningCode;
        
        [XmlElementAttribute("WarningCode", Order=77, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareDefaultWarningCode_2> WarningCode
        {
            get
            {
                return _warningCode;
