...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("UpdateStockByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateStockByIdRequest
    {
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("StockType", Order=0, Form=XmlSchemaForm.Unqualified)]
        public short StockTypeValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the StockType property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool StockTypeValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<short> StockType
        {
            get
            {
                if (this.StockTypeValueSpecified)
                {
            ...
            set
            {
                this.StockTypeValue = value.GetValueOrDefault();
                this.StockTypeValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("StockFields", Order=3, Form=XmlSchemaForm.Unqualified)]
        public ParameterService.StockFields_2 StockFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateStockByIdRequest" /> class.</para>
        /// </summary>
        public UpdateStockByIdRequest()
        {
