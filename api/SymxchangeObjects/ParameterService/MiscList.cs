...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("MiscList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class MiscList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Misc> _misc;
        
        [XmlElementAttribute("Misc", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Misc> Misc
        {
            get
            {
                return _misc;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="MiscList" /> class.</para>
        /// </summary>
        public MiscList()
        {
            this._misc = new Collection<Misc>();
        }
    }
}
