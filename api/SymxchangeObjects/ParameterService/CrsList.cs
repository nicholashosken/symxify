...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("CrsList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class CrsList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Crs> _crs;
        
        [XmlElementAttribute("Crs", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Crs> Crs
        {
            get
            {
                return _crs;
        ...
        /// <summary>
        /// <para xml:lang="en">Gets a value indicating whether the Crs collection is empty.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        public bool CrsSpecified
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CrsList" /> class.</para>
        /// </summary>
        public CrsList()
        {
            this._crs = new Collection<Crs>();
        }
    }
}
