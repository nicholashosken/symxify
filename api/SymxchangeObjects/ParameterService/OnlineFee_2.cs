...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("OnlineFee", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("OnlineFee", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(OnlineFeeFields_2))]
    public partial class OnlineFee_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<OnlineFeeRelationFeeAmount_2> _relationFeeAmount;
        
        [XmlElementAttribute("RelationFeeAmount", Order=14, Form=XmlSchemaForm.Unqualified)]
        public Collection<OnlineFeeRelationFeeAmount_2> RelationFeeAmount
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="OnlineFee_2" /> class.</para>
        /// </summary>
        public OnlineFee_2()
        {
            this._relationFeeAmount = new Collection<OnlineFeeRelationFeeAmount_2>();
            this._relationRelCodes = new Collection<OnlineFeeRelationRelCodes_2>();
            this._relationWaiveCount = new Collection<OnlineFeeRelationWaiveCount_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<OnlineFeeRelationRelCodes_2> _relationRelCodes;
        
        [XmlElementAttribute("RelationRelCodes", Order=15, Form=XmlSchemaForm.Unqualified)]
        public Collection<OnlineFeeRelationRelCodes_2> RelationRelCodes
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<OnlineFeeRelationWaiveCount_2> _relationWaiveCount;
        
        [XmlElementAttribute("RelationWaiveCount", Order=16, Form=XmlSchemaForm.Unqualified)]
        public Collection<OnlineFeeRelationWaiveCount_2> RelationWaiveCount
        {
            get
            {
