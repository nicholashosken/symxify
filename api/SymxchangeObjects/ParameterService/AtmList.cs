...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("AtmList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class AtmList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Atm> _atm;
        
        [XmlElementAttribute("Atm", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Atm> Atm
        {
            get
            {
                return _atm;
        ...
        /// <summary>
        /// <para xml:lang="en">Gets a value indicating whether the Atm collection is empty.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="AtmList" /> class.</para>
        /// </summary>
        public AtmList()
        {
            this._atm = new Collection<Atm>();
        }
    }
}
