...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("GlxLateList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class GlxLateList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<GlxLate> _glxLate;
        
        [XmlElementAttribute("GlxLate", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<GlxLate> GlxLate
        {
            get
            {
                return _glxLate;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="GlxLateList" /> class.</para>
        /// </summary>
        public GlxLateList()
        {
            this._glxLate = new Collection<GlxLate>();
        }
    }
}
