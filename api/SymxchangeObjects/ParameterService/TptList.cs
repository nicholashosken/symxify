...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("TptList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class TptList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Tpt> _tpt;
        
        [XmlElementAttribute("Tpt", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Tpt> Tpt
        {
            get
            {
                return _tpt;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="TptList" /> class.</para>
        /// </summary>
        public TptList()
        {
            this._tpt = new Collection<Tpt>();
        }
    }
}
