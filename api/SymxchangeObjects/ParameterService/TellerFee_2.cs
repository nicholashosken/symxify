...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("TellerFee", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("TellerFee", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/update")]
    [XmlIncludeAttribute(typeof(TellerFeeFields_2))]
    public partial class TellerFee_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<TellerFeeRelCodeList_2> _relCodeList;
        
        [XmlElementAttribute("RelCodeList", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<TellerFeeRelCodeList_2> RelCodeList
        {
            get
            {
                return _relCodeList;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="TellerFee_2" /> class.</para>
        /// </summary>
        public TellerFee_2()
        {
            this._relCodeList = new Collection<TellerFeeRelCodeList_2>();
            this._relSvLnTypes = new Collection<TellerFeeRelSvLnTypes_2>();
            this._relationBaseAmount = new Collection<TellerFeeRelationBaseAmount_2>();
            this._relationBaseCount = new Collection<TellerFeeRelationBaseCount_2>();
            this._relationFeeAmount = new Collection<TellerFeeRelationFeeAmount_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<TellerFeeRelSvLnTypes_2> _relSvLnTypes;
        
        [XmlElementAttribute("RelSvLnTypes", Order=4, Form=XmlSchemaForm.Unqualified)]
        public Collection<TellerFeeRelSvLnTypes_2> RelSvLnTypes
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<TellerFeeRelationBaseAmount_2> _relationBaseAmount;
        
        [XmlElementAttribute("RelationBaseAmount", Order=5, Form=XmlSchemaForm.Unqualified)]
        public Collection<TellerFeeRelationBaseAmount_2> RelationBaseAmount
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<TellerFeeRelationBaseCount_2> _relationBaseCount;
        
        [XmlElementAttribute("RelationBaseCount", Order=6, Form=XmlSchemaForm.Unqualified)]
        public Collection<TellerFeeRelationBaseCount_2> RelationBaseCount
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<TellerFeeRelationFeeAmount_2> _relationFeeAmount;
        
        [XmlElementAttribute("RelationFeeAmount", Order=7, Form=XmlSchemaForm.Unqualified)]
        public Collection<TellerFeeRelationFeeAmount_2> RelationFeeAmount
        {
            get
            {
