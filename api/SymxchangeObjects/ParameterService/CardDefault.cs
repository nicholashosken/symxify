...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("CardDefault", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CardDefault", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class CardDefault
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardDefaultCountLimit> _countLimit;
        
        [XmlElementAttribute("CountLimit", Order=9, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardDefaultCountLimit> CountLimit
        {
            get
            {
                return _countLimit;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CardDefault" /> class.</para>
        /// </summary>
        public CardDefault()
        {
            this._countLimit = new Collection<CardDefaultCountLimit>();
            this._limit = new Collection<CardDefaultLimit>();
            this._miscId = new Collection<CardDefaultMiscId>();
            this._perItemLimit = new Collection<CardDefaultPerItemLimit>();
            this._service = new Collection<CardDefaultService>();
            this._warningCode = new Collection<CardDefaultWarningCode>();
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("EffectiveDate", Order=19, Form=XmlSchemaForm.Unqualified, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("ExpirationDate", Order=21, Form=XmlSchemaForm.Unqualified, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("IssueDate", Order=24, Form=XmlSchemaForm.Unqualified, DataType="date")]
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardDefaultLimit> _limit;
        
        [XmlElementAttribute("Limit", Order=25, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardDefaultLimit> Limit
        {
            get
            {
                return _limit;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardDefaultMiscId> _miscId;
        
        [XmlElementAttribute("MiscId", Order=30, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardDefaultMiscId> MiscId
        {
            get
            {
                return _miscId;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardDefaultPerItemLimit> _perItemLimit;
        
        [XmlElementAttribute("PerItemLimit", Order=35, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardDefaultPerItemLimit> PerItemLimit
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardDefaultService> _service;
        
        [XmlElementAttribute("Service", Order=45, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardDefaultService> Service
        {
            get
            {
                return _service;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardDefaultWarningCode> _warningCode;
        
        [XmlElementAttribute("WarningCode", Order=51, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardDefaultWarningCode> WarningCode
        {
            get
            {
                return _warningCode;
