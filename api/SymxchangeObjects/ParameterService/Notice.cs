...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("Notice", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("Notice", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class Notice
    {
        
        [XmlIgnoreAttribute()]
        private Collection<NoticeDaysBetweenNotices> _daysBetweenNotices;
        
        [XmlElementAttribute("DaysBetweenNotices", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<NoticeDaysBetweenNotices> DaysBetweenNotices
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="Notice" /> class.</para>
        /// </summary>
        public Notice()
        {
            this._daysBetweenNotices = new Collection<NoticeDaysBetweenNotices>();
            this._line1 = new Collection<NoticeLine1>();
            this._line2 = new Collection<NoticeLine2>();
            this._line3 = new Collection<NoticeLine3>();
            this._line4 = new Collection<NoticeLine4>();
            this._negativeInfoMessage = new Collection<NoticeNegativeInfoMessage>();
        ...
        [XmlIgnoreAttribute()]
        private Collection<NoticeLine1> _line1;
        
        [XmlElementAttribute("Line1", Order=2, Form=XmlSchemaForm.Unqualified)]
        public Collection<NoticeLine1> Line1
        {
            get
            {
                return _line1;
        ...
        [XmlIgnoreAttribute()]
        private Collection<NoticeLine2> _line2;
        
        [XmlElementAttribute("Line2", Order=3, Form=XmlSchemaForm.Unqualified)]
        public Collection<NoticeLine2> Line2
        {
            get
            {
                return _line2;
        ...
        [XmlIgnoreAttribute()]
        private Collection<NoticeLine3> _line3;
        
        [XmlElementAttribute("Line3", Order=4, Form=XmlSchemaForm.Unqualified)]
        public Collection<NoticeLine3> Line3
        {
            get
            {
                return _line3;
        ...
        [XmlIgnoreAttribute()]
        private Collection<NoticeLine4> _line4;
        
        [XmlElementAttribute("Line4", Order=5, Form=XmlSchemaForm.Unqualified)]
        public Collection<NoticeLine4> Line4
        {
            get
            {
                return _line4;
        ...
        [XmlIgnoreAttribute()]
        private Collection<NoticeNegativeInfoMessage> _negativeInfoMessage;
        
        [XmlElementAttribute("NegativeInfoMessage", Order=6, Form=XmlSchemaForm.Unqualified)]
        public Collection<NoticeNegativeInfoMessage> NegativeInfoMessage
        {
            get
            {
