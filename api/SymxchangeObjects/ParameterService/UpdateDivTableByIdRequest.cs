...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("UpdateDivTableByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateDivTableByIdRequest
    {
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("DivTableType", Order=0, Form=XmlSchemaForm.Unqualified)]
        public short DivTableTypeValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the DivTableType property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool DivTableTypeValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<short> DivTableType
        {
            get
            {
                if (this.DivTableTypeValueSpecified)
                {
                    return this.DivTableTypeValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.DivTableTypeValue = value.GetValueOrDefault();
                this.DivTableTypeValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("DivTableFields", Order=3, Form=XmlSchemaForm.Unqualified)]
        public ParameterService.DivTableFields_2 DivTableFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateDivTableByIdRequest" /> class.</para>
        /// </summary>
        public UpdateDivTableByIdRequest()
        {
