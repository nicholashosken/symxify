...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("CreditReportList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    ...
    public partial class CreditReportList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CreditReport> _creditReport;
        
        [XmlElementAttribute("CreditReport", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<CreditReport> CreditReport
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Gets a value indicating whether the CreditReport collection is empty.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        public bool CreditReportSpecified
        {
            get
            {
                return ((this.CreditReport != null) 
                            && (this.CreditReport.Count != 0));
            }
        }
        
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CreditReportList" /> class.</para>
        /// </summary>
        public CreditReportList()
        {
            this._creditReport = new Collection<CreditReport>();
        }
    }
}
