...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("SecurityList", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    ...
    public partial class SecurityList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Security> _security;
        
        [XmlElementAttribute("Security", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Security> Security
        {
            get
            {
                return _security;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="SecurityList" /> class.</para>
        /// </summary>
        public SecurityList()
        {
            this._security = new Collection<Security>();
        }
    }
}
