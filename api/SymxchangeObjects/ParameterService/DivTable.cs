...
namespace ParameterService
{
    ...
    [XmlTypeAttribute("DivTable", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("DivTable", Namespace="http://www.symxchange.generated.symitar.com/crud/parameter/dto/retrieve")]
    public partial class DivTable
    {
        
        [XmlIgnoreAttribute()]
        private Collection<DivTableBalanceCutoff> _balanceCutoff;
        
        [XmlElementAttribute("BalanceCutoff", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<DivTableBalanceCutoff> BalanceCutoff
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="DivTable" /> class.</para>
        /// </summary>
        public DivTable()
        {
            this._balanceCutoff = new Collection<DivTableBalanceCutoff>();
            this._lrbGraceDays = new Collection<DivTableLrbGraceDays>();
            this._marginRate = new Collection<DivTableMarginRate>();
            this._rate = new Collection<DivTableRate>();
            this._relCodeList = new Collection<DivTableRelCodeList>();
            this._table = new Collection<DivTableTable>();
        ...
        [XmlIgnoreAttribute()]
        private Collection<DivTableLrbGraceDays> _lrbGraceDays;
        
        [XmlElementAttribute("LrbGraceDays", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<DivTableLrbGraceDays> LrbGraceDays
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<DivTableMarginRate> _marginRate;
        
        [XmlElementAttribute("MarginRate", Order=9, Form=XmlSchemaForm.Unqualified)]
        public Collection<DivTableMarginRate> MarginRate
        {
            get
            {
                return _marginRate;
        ...
        [XmlIgnoreAttribute()]
        private Collection<DivTableRate> _rate;
        
        [XmlElementAttribute("Rate", Order=16, Form=XmlSchemaForm.Unqualified)]
        public Collection<DivTableRate> Rate
        {
            get
            {
                return _rate;
        ...
        [XmlIgnoreAttribute()]
        private Collection<DivTableRelCodeList> _relCodeList;
        
        [XmlElementAttribute("RelCodeList", Order=18, Form=XmlSchemaForm.Unqualified)]
        public Collection<DivTableRelCodeList> RelCodeList
        {
            get
            {
                return _relCodeList;
        ...
        [XmlIgnoreAttribute()]
        private Collection<DivTableTable> _table;
        
        [XmlElementAttribute("Table", Order=20, Form=XmlSchemaForm.Unqualified)]
        public Collection<DivTableTable> Table
        {
            get
            {
                return _table;
