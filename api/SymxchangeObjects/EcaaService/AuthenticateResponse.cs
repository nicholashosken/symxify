...
namespace EcaaService
{
    ...
    [XmlTypeAttribute("authenticateResponse", Namespace="http://www.symxchange.generated.symitar.com/noncrud/ecaa/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class AuthenticateResponse : EcaaBaseResponse
    {
        
        [RequiredAttribute(AllowEmptyStrings=true)]
        [XmlElementAttribute("AuthenticateResult", Order=0, Form=XmlSchemaForm.Unqualified)]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="AuthenticateResponse" /> class.</para>
        /// </summary>
