...
namespace EcaaService
{
    ...
    [XmlTypeAttribute("getPrincipalsResult", Namespace="http://www.symxchange.generated.symitar.com/noncrud/ecaa/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class GetPrincipalsResult : CommonResult
    {
        
        [XmlIgnoreAttribute()]
        private Collection<PrincipalInformation> _information;
        
        [XmlElementAttribute("Information", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<PrincipalInformation> Information
        {
            get
            {
                return _information;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="GetPrincipalsResult" /> class.</para>
        /// </summary>
        public GetPrincipalsResult()
        {
            this._information = new Collection<PrincipalInformation>();
