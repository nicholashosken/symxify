...
namespace CollateralService
{
    ...
    [XmlTypeAttribute("UpdateCollateralTrackingByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/collateral")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateCollateralTrackingByIdRequest
    {
        ...
        [XmlElementAttribute("CollateralTrackingLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int CollateralTrackingLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the CollateralTrackingLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool CollateralTrackingLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> CollateralTrackingLocator
        {
            get
            {
                if (this.CollateralTrackingLocatorValueSpecified)
                {
                    return this.CollateralTrackingLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.CollateralTrackingLocatorValue = value.GetValueOrDefault();
                this.CollateralTrackingLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("CollateralTrackingFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public CollateralService.CollateralTrackingFields_2 CollateralTrackingFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateCollateralTrackingByIdRequest" /> class.</para>
        /// </summary>
        public UpdateCollateralTrackingByIdRequest()
        {
