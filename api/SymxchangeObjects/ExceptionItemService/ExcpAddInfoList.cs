...
namespace ExceptionItemService
{
    ...
    [XmlTypeAttribute("ExcpAddInfoList", Namespace="http://www.symxchange.generated.symitar.com/crud/exceptionitem/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ExcpAddInfoList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ExcpAddInfo> _excpAddInfo;
        
        [XmlElementAttribute("ExcpAddInfo", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExcpAddInfo> ExcpAddInfo
        {
            get
            {
                return _excpAddInfo;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ExcpAddInfoList" /> class.</para>
        /// </summary>
        public ExcpAddInfoList()
        {
            this._excpAddInfo = new Collection<ExcpAddInfo>();
        }
    }
}
