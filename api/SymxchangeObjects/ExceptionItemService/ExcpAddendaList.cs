...
namespace ExceptionItemService
{
    ...
    [XmlTypeAttribute("ExcpAddendaList", Namespace="http://www.symxchange.generated.symitar.com/crud/exceptionitem/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class ExcpAddendaList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ExcpAddenda> _excpAddenda;
        
        [XmlElementAttribute("ExcpAddenda", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExcpAddenda> ExcpAddenda
        {
            get
            {
                return _excpAddenda;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ExcpAddendaList" /> class.</para>
        /// </summary>
        public ExcpAddendaList()
        {
            this._excpAddenda = new Collection<ExcpAddenda>();
        }
    }
}
