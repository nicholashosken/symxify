...
namespace MemberService
{
    ...
    [XmlTypeAttribute("MemberRecFmHistorySearchPagedSelectFieldsRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/member")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class MemberRecFmHistorySearchPagedSelectFieldsRequest
    {
        ...
        public MemberService.PagingRequestContext PagingRequestContext { get; set; }
        
        [XmlElementAttribute("SelectableFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public MemberService.MemberRecFmHistorySingleSelectableFields SelectableFields { get; set; }
        
        [XmlElementAttribute("SearchFilter", Order=5, Form=XmlSchemaForm.Unqualified)]
        public MemberService.MemberRecFmHistorySearchFilter SearchFilter { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="MemberRecFmHistorySearchPagedSelectFieldsRequest" /> class.</para>
        /// </summary>
        public MemberRecFmHistorySearchPagedSelectFieldsRequest()
        {
