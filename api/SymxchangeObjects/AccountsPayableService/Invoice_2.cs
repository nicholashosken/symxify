...
namespace AccountsPayableService
{
    ...
    [XmlTypeAttribute("Invoice", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("Invoice", Namespace="http://www.symxchange.generated.symitar.com/crud/accountspayable/dto/update")]
    [XmlIncludeAttribute(typeof(InvoiceFields_2))]
    public partial class Invoice_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoiceCompletedActions_2> _completedActions;
        
        [XmlElementAttribute("CompletedActions", Order=6, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoiceCompletedActions_2> CompletedActions
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="Invoice_2" /> class.</para>
        /// </summary>
        public Invoice_2()
        {
            this._completedActions = new Collection<InvoiceCompletedActions_2>();
            this._dueAmount = new Collection<InvoiceDueAmount_2>();
            this._dueDate = new Collection<InvoiceDueDate_2>();
            this._expenseAmount = new Collection<InvoiceExpenseAmount_2>();
            this._expenseTable = new Collection<InvoiceExpenseTable_2>();
            this._glExpense = new Collection<InvoiceGlExpense_2>();
            this._glNameExpense = new Collection<InvoiceGlNameExpense_2>();
            this._paymentAmount = new Collection<InvoicePaymentAmount_2>();
            this._paymentCheck = new Collection<InvoicePaymentCheck_2>();
            this._paymentDate = new Collection<InvoicePaymentDate_2>();
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("DiscountDate", Order=11, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> DiscountDateValue { get; set; }
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoiceDueAmount_2> _dueAmount;
        
        [XmlElementAttribute("DueAmount", Order=13, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoiceDueAmount_2> DueAmount
        {
            get
            {
                return _dueAmount;
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoiceDueDate_2> _dueDate;
        
        [XmlElementAttribute("DueDate", Order=14, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoiceDueDate_2> DueDate
        {
            get
            {
                return _dueDate;
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("DueDateFinal", Order=15, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> DueDateFinalValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("EventDate", Order=17, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("ExpEffectiveDate", Order=18, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> ExpEffectiveDateValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("ExpPostDate", Order=19, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> ExpPostDateValue { get; set; }
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoiceExpenseAmount_2> _expenseAmount;
        
        [XmlElementAttribute("ExpenseAmount", Order=20, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoiceExpenseAmount_2> ExpenseAmount
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoiceExpenseTable_2> _expenseTable;
        
        [XmlElementAttribute("ExpenseTable", Order=21, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoiceExpenseTable_2> ExpenseTable
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoiceGlExpense_2> _glExpense;
        
        [XmlElementAttribute("GlExpense", Order=24, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoiceGlExpense_2> GlExpense
        {
            get
            {
                return _glExpense;
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoiceGlNameExpense_2> _glNameExpense;
        
        [XmlElementAttribute("GlNameExpense", Order=27, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoiceGlNameExpense_2> GlNameExpense
        {
            get
            {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("InvoiceDate", Order=29, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> InvoiceDateValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("LastFmDate", Order=31, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("NextRecurInvoiceDate", Order=33, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> NextRecurInvoiceDateValue { get; set; }
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoicePaymentAmount_2> _paymentAmount;
        
        [XmlElementAttribute("PaymentAmount", Order=36, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoicePaymentAmount_2> PaymentAmount
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoicePaymentCheck_2> _paymentCheck;
        
        [XmlElementAttribute("PaymentCheck", Order=37, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoicePaymentCheck_2> PaymentCheck
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<InvoicePaymentDate_2> _paymentDate;
        
        [XmlElementAttribute("PaymentDate", Order=38, Form=XmlSchemaForm.Unqualified)]
        public Collection<InvoicePaymentDate_2> PaymentDate
        {
            get
            {
                return _paymentDate;
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("RecordChangeDate", Order=42, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("RecurrenceEndDate", Order=45, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> RecurrenceEndDateValue { get; set; }
