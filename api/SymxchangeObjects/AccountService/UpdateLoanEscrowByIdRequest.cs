...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateLoanEscrowByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateLoanEscrowByIdRequest
    {
        ...
        [XmlElementAttribute("LoanEscrowLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int LoanEscrowLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the LoanEscrowLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool LoanEscrowLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> LoanEscrowLocator
        {
            get
            {
                if (this.LoanEscrowLocatorValueSpecified)
                {
                    return this.LoanEscrowLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.LoanEscrowLocatorValue = value.GetValueOrDefault();
                this.LoanEscrowLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("LoanEscrowFields", Order=5, Form=XmlSchemaForm.Unqualified)]
        public AccountService.LoanEscrowFields_2 LoanEscrowFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateLoanEscrowByIdRequest" /> class.</para>
        /// </summary>
        public UpdateLoanEscrowByIdRequest()
        {
