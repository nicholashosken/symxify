...
namespace AccountService
{
    ...
    [XmlTypeAttribute("TrackingList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    ...
    public partial class TrackingList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Tracking> _tracking;
        
        [XmlElementAttribute("Tracking", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Tracking> Tracking
        {
            get
            {
                return _tracking;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="TrackingList" /> class.</para>
        /// </summary>
        public TrackingList()
        {
            this._tracking = new Collection<Tracking>();
        }
    }
}
