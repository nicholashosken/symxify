...
namespace AccountService
{
    ...
    [XmlTypeAttribute("EftList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class EftList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Eft> _eft;
        
        [XmlElementAttribute("Eft", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Eft> Eft
        {
            get
            {
                return _eft;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="EftList" /> class.</para>
        /// </summary>
        public EftList()
        {
            this._eft = new Collection<Eft>();
        }
    }
}
