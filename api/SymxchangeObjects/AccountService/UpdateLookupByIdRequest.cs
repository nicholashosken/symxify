...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateLookupByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateLookupByIdRequest
    {
        ...
        [XmlElementAttribute("LookupLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int LookupLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the LookupLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool LookupLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> LookupLocator
        {
            get
            {
                if (this.LookupLocatorValueSpecified)
                {
                    return this.LookupLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.LookupLocatorValue = value.GetValueOrDefault();
                this.LookupLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("LookupFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public AccountService.LookupFields_2 LookupFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateLookupByIdRequest" /> class.</para>
        /// </summary>
        public UpdateLookupByIdRequest()
        {
