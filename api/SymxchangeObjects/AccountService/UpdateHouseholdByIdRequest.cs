...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateHouseholdByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateHouseholdByIdRequest
    {
        ...
        [XmlElementAttribute("HouseholdLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int HouseholdLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the HouseholdLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool HouseholdLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> HouseholdLocator
        {
            get
            {
                if (this.HouseholdLocatorValueSpecified)
                {
                    return this.HouseholdLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.HouseholdLocatorValue = value.GetValueOrDefault();
                this.HouseholdLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("HouseholdFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public AccountService.HouseholdFields_2 HouseholdFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateHouseholdByIdRequest" /> class.</para>
        /// </summary>
        public UpdateHouseholdByIdRequest()
        {
