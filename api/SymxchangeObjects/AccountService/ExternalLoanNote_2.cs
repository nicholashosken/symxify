...
namespace AccountService
{
    ...
    [XmlTypeAttribute("ExternalLoanNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("ExternalLoanNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(ExternalLoanNoteFields_2))]
    public partial class ExternalLoanNote_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ExternalLoanNoteText_2> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<ExternalLoanNoteText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ExternalLoanNote_2" /> class.</para>
        /// </summary>
        public ExternalLoanNote_2()
        {
            this._text = new Collection<ExternalLoanNoteText_2>();
