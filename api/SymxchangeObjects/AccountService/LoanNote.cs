...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class LoanNote
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanNoteText> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanNoteText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanNote" /> class.</para>
        /// </summary>
        public LoanNote()
        {
            this._text = new Collection<LoanNoteText>();
