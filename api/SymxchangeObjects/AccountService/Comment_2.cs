...
namespace AccountService
{
    ...
    [XmlTypeAttribute("Comment", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("Comment", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(CommentFields_2))]
    public partial class Comment_2
    {
        
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("EffectiveDate", Order=0, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("ExpirationDate", Order=1, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("RecordChangeDate", Order=3, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [XmlElementAttribute("Text", Order=4, Form=XmlSchemaForm.Unqualified)]
