...
namespace AccountService
{
    ...
    [XmlTypeAttribute("HouseholdList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class HouseholdList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Household> _household;
        
        [XmlElementAttribute("Household", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Household> Household
        {
            get
            {
                return _household;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="HouseholdList" /> class.</para>
        /// </summary>
        public HouseholdList()
        {
            this._household = new Collection<Household>();
        }
    }
}
