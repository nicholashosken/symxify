...
namespace AccountService
{
    ...
    [XmlTypeAttribute("ShareList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    ...
    public partial class ShareList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<Share> _share;
        
        [XmlElementAttribute("Share", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<Share> Share
        {
            get
            {
                return _share;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ShareList" /> class.</para>
        /// </summary>
        public ShareList()
        {
            this._share = new Collection<Share>();
        }
    }
}
