...
namespace AccountService
{
    ...
    [XmlTypeAttribute("CardName", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("CardName", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    public partial class CardName
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardNameIdentDocFlag> _identDocFlag;
        
        [XmlElementAttribute("IdentDocFlag", Order=58, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardNameIdentDocFlag> IdentDocFlag
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="CardName" /> class.</para>
        /// </summary>
        public CardName()
        {
            this._identDocFlag = new Collection<CardNameIdentDocFlag>();
            this._identIdDescription = new Collection<CardNameIdentIdDescription>();
            this._identIdExpireDate = new Collection<CardNameIdentIdExpireDate>();
            this._identIdIssueDate = new Collection<CardNameIdentIdIssueDate>();
            this._identIdNumber = new Collection<CardNameIdentIdNumber>();
            this._identIdType = new Collection<CardNameIdentIdType>();
            this._identIdVerifyDate = new Collection<CardNameIdentIdVerifyDate>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<CardNameIdentIdDescription> _identIdDescription;
        
        [XmlElementAttribute("IdentIdDescription", Order=59, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardNameIdentIdDescription> IdentIdDescription
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardNameIdentIdExpireDate> _identIdExpireDate;
        
        [XmlElementAttribute("IdentIdExpireDate", Order=60, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardNameIdentIdExpireDate> IdentIdExpireDate
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardNameIdentIdIssueDate> _identIdIssueDate;
        
        [XmlElementAttribute("IdentIdIssueDate", Order=61, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardNameIdentIdIssueDate> IdentIdIssueDate
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardNameIdentIdNumber> _identIdNumber;
        
        [XmlElementAttribute("IdentIdNumber", Order=62, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardNameIdentIdNumber> IdentIdNumber
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardNameIdentIdType> _identIdType;
        
        [XmlElementAttribute("IdentIdType", Order=63, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardNameIdentIdType> IdentIdType
        {
            get
            {
                return _identIdType;
        ...
        [XmlIgnoreAttribute()]
        private Collection<CardNameIdentIdVerifyDate> _identIdVerifyDate;
        
        [XmlElementAttribute("IdentIdVerifyDate", Order=64, Form=XmlSchemaForm.Unqualified)]
        public Collection<CardNameIdentIdVerifyDate> IdentIdVerifyDate
        {
            get
            {
