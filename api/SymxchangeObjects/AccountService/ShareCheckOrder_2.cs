...
namespace AccountService
{
    ...
    [XmlTypeAttribute("ShareCheckOrder", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("ShareCheckOrder", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(ShareCheckOrderFields_2))]
    public partial class ShareCheckOrder_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareCheckOrderBusCaptions_2> _busCaptions;
        
        [XmlElementAttribute("BusCaptions", Order=6, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareCheckOrderBusCaptions_2> BusCaptions
        {
            get
            {
                return _busCaptions;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ShareCheckOrder_2" /> class.</para>
        /// </summary>
        public ShareCheckOrder_2()
        {
            this._busCaptions = new Collection<ShareCheckOrderBusCaptions_2>();
            this._imprintLine = new Collection<ShareCheckOrderImprintLine_2>();
            this._imprintLineSize = new Collection<ShareCheckOrderImprintLineSize_2>();
            this._imprintUsage = new Collection<ShareCheckOrderImprintUsage_2>();
            this._license = new Collection<ShareCheckOrderLicense_2>();
            this._mailAddress = new Collection<ShareCheckOrderMailAddress_2>();
            this._overSigLine = new Collection<ShareCheckOrderOverSigLine_2>();
            this._specialInstr = new Collection<ShareCheckOrderSpecialInstr_2>();
            this._ssn = new Collection<ShareCheckOrderSsn_2>();
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareCheckOrderImprintLine_2> _imprintLine;
        
        [XmlElementAttribute("ImprintLine", Order=22, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareCheckOrderImprintLine_2> ImprintLine
        {
            get
            {
                return _imprintLine;
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareCheckOrderImprintLineSize_2> _imprintLineSize;
        
        [XmlElementAttribute("ImprintLineSize", Order=23, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareCheckOrderImprintLineSize_2> ImprintLineSize
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareCheckOrderImprintUsage_2> _imprintUsage;
        
        [XmlElementAttribute("ImprintUsage", Order=26, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareCheckOrderImprintUsage_2> ImprintUsage
        {
            get
            {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("LastFmDate", Order=28, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("LastFreeOrder", Order=29, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        public Nullable<DateTime> LastFreeOrderValue { get; set; }
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("LastOrderDate", Order=30, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareCheckOrderLicense_2> _license;
        
        [XmlElementAttribute("License", Order=31, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareCheckOrderLicense_2> License
        {
            get
            {
                return _license;
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareCheckOrderMailAddress_2> _mailAddress;
        
        [XmlElementAttribute("MailAddress", Order=33, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareCheckOrderMailAddress_2> MailAddress
        {
            get
            {
                return _mailAddress;
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("OpenDate", Order=39, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareCheckOrderOverSigLine_2> _overSigLine;
        
        [XmlElementAttribute("OverSigLine", Order=42, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareCheckOrderOverSigLine_2> OverSigLine
        {
            get
            {
                return _overSigLine;
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("RecordChangeDate", Order=49, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareCheckOrderSpecialInstr_2> _specialInstr;
        
        [XmlElementAttribute("SpecialInstr", Order=54, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareCheckOrderSpecialInstr_2> SpecialInstr
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<ShareCheckOrderSsn_2> _ssn;
        
        [XmlElementAttribute("Ssn", Order=55, Form=XmlSchemaForm.Unqualified)]
        public Collection<ShareCheckOrderSsn_2> Ssn
        {
            get
            {
                return _ssn;
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("StatusDate", Order=58, Form=XmlSchemaForm.Unqualified, IsNullable=true, DataType="date")]
