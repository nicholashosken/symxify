...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateShareHoldByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateShareHoldByIdRequest
    {
        ...
        [XmlElementAttribute("ShareHoldLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int ShareHoldLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the ShareHoldLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool ShareHoldLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> ShareHoldLocator
        {
            get
            {
                if (this.ShareHoldLocatorValueSpecified)
                {
                    return this.ShareHoldLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.ShareHoldLocatorValue = value.GetValueOrDefault();
                this.ShareHoldLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("ShareHoldFields", Order=5, Form=XmlSchemaForm.Unqualified)]
        public AccountService.ShareHoldFields_2 ShareHoldFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateShareHoldByIdRequest" /> class.</para>
        /// </summary>
        public UpdateShareHoldByIdRequest()
        {
