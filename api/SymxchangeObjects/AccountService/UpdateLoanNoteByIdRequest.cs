...
namespace AccountService
{
    ...
    [XmlTypeAttribute("UpdateLoanNoteByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/account")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateLoanNoteByIdRequest
    {
        ...
        [XmlElementAttribute("LoanNoteLocator", Order=2, Form=XmlSchemaForm.Unqualified)]
        public int LoanNoteLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the LoanNoteLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool LoanNoteLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> LoanNoteLocator
        {
            get
            {
                if (this.LoanNoteLocatorValueSpecified)
                {
                    return this.LoanNoteLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.LoanNoteLocatorValue = value.GetValueOrDefault();
                this.LoanNoteLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("LoanNoteFields", Order=5, Form=XmlSchemaForm.Unqualified)]
        public AccountService.LoanNoteFields_2 LoanNoteFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateLoanNoteByIdRequest" /> class.</para>
        /// </summary>
        public UpdateLoanNoteByIdRequest()
        {
