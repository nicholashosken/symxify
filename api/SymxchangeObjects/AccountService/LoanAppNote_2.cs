...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanAppNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanAppNote", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(LoanAppNoteFields_2))]
    public partial class LoanAppNote_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppNoteText_2> _text;
        
        [XmlElementAttribute("Text", Order=8, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppNoteText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanAppNote_2" /> class.</para>
        /// </summary>
        public LoanAppNote_2()
        {
            this._text = new Collection<LoanAppNoteText_2>();
