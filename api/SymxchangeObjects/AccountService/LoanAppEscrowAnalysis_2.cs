...
namespace AccountService
{
    ...
    [XmlTypeAttribute("LoanAppEscrowAnalysis", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("LoanAppEscrowAnalysis", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/update")]
    [XmlIncludeAttribute(typeof(LoanAppEscrowAnalysisFields_2))]
    public partial class LoanAppEscrowAnalysis_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppEscrowAnalysisNewEscrowPayment_2> _newEscrowPayment;
        
        [XmlElementAttribute("NewEscrowPayment", Order=25, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppEscrowAnalysisNewEscrowPayment_2> NewEscrowPayment
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="LoanAppEscrowAnalysis_2" /> class.</para>
        /// </summary>
        public LoanAppEscrowAnalysis_2()
        {
            this._newEscrowPayment = new Collection<LoanAppEscrowAnalysisNewEscrowPayment_2>();
            this._newPaymentDate = new Collection<LoanAppEscrowAnalysisNewPaymentDate_2>();
            this._prevNewEscrowPmt = new Collection<LoanAppEscrowAnalysisPrevNewEscrowPmt_2>();
            this._prevNewPmtDate = new Collection<LoanAppEscrowAnalysisPrevNewPmtDate_2>();
            this._any = new Collection<XmlElement>();
        }
        
        [XmlIgnoreAttribute()]
        private Collection<LoanAppEscrowAnalysisNewPaymentDate_2> _newPaymentDate;
        
        [XmlElementAttribute("NewPaymentDate", Order=26, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppEscrowAnalysisNewPaymentDate_2> NewPaymentDate
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppEscrowAnalysisPrevNewEscrowPmt_2> _prevNewEscrowPmt;
        
        [XmlElementAttribute("PrevNewEscrowPmt", Order=51, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppEscrowAnalysisPrevNewEscrowPmt_2> PrevNewEscrowPmt
        {
            get
            {
        ...
        [XmlIgnoreAttribute()]
        private Collection<LoanAppEscrowAnalysisPrevNewPmtDate_2> _prevNewPmtDate;
        
        [XmlElementAttribute("PrevNewPmtDate", Order=52, Form=XmlSchemaForm.Unqualified)]
        public Collection<LoanAppEscrowAnalysisPrevNewPmtDate_2> PrevNewPmtDate
        {
            get
            {
