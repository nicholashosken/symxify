...
namespace AccountService
{
    ...
    [XmlTypeAttribute("EftTransferList", Namespace="http://www.symxchange.generated.symitar.com/crud/account/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class EftTransferList
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<EftTransfer> _eftTransfer;
        
        [XmlElementAttribute("EftTransfer", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<EftTransfer> EftTransfer
        {
            get
            {
                return _eftTransfer;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="EftTransferList" /> class.</para>
        /// </summary>
        public EftTransferList()
        {
            this._eftTransfer = new Collection<EftTransfer>();
        }
    }
}
