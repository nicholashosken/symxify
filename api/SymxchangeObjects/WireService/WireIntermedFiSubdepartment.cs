...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireIntermedFiSubdepartment", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireIntermedFiSubdepartment", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireIntermedFiSubdepartment
    {
        ...
        [XmlElementAttribute("IntermedFiSubdepartment", Order=1, Form=XmlSchemaForm.Unqualified)]
        public string IntermedFiSubdepartment { get; set; }
    }
}
