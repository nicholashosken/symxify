...
namespace WireService
{
    ...
    [XmlTypeAttribute("UpdateWireBeneficiaryInfoByIDRequest", Namespace="http://www.symxchange.generated.symitar.com/crud/wire")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class UpdateWireBeneficiaryInfoByIdRequest
    {
        ...
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        [XmlElementAttribute("WireBeneficiaryInfoLocator", Order=1, Form=XmlSchemaForm.Unqualified)]
        public int WireBeneficiaryInfoLocatorValue { get; set; }
        
        /// <summary>
        /// <para xml:lang="en">Gets or sets a value indicating whether the WireBeneficiaryInfoLocator property is specified.</para>
        /// </summary>
        [XmlIgnoreAttribute()]
        [EditorBrowsableAttribute(EditorBrowsableState.Never)]
        public bool WireBeneficiaryInfoLocatorValueSpecified { get; set; }
        
        [XmlIgnoreAttribute()]
        public Nullable<int> WireBeneficiaryInfoLocator
        {
            get
            {
                if (this.WireBeneficiaryInfoLocatorValueSpecified)
                {
                    return this.WireBeneficiaryInfoLocatorValue;
                }
                else
                {
                    return null;
            ...
            set
            {
                this.WireBeneficiaryInfoLocatorValue = value.GetValueOrDefault();
                this.WireBeneficiaryInfoLocatorValueSpecified = value.HasValue;
            }
        }
        ...
        [XmlElementAttribute("WireBeneficiaryInfoFields", Order=4, Form=XmlSchemaForm.Unqualified)]
        public WireService.WireBeneficiaryInfoFields_2 WireBeneficiaryInfoFields { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UpdateWireBeneficiaryInfoByIdRequest" /> class.</para>
        /// </summary>
        public UpdateWireBeneficiaryInfoByIdRequest()
        {
