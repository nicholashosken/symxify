...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireBeneficiaryAdvSearchPagedSelectFieldsResponse", Namespace="http://www.symxchange.generated.symitar.com/crud/wire")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class WireBeneficiaryAdvSearchPagedSelectFieldsResponse
    {
        
        [XmlIgnoreAttribute()]
        private Collection<WireService.WireBeneficiaryAdv> _wireBeneficiaryAdv;
        
        [XmlElementAttribute("WireBeneficiaryAdv", Order=0, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireService.WireBeneficiaryAdv> WireBeneficiaryAdv
        {
            get
            {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireBeneficiaryAdvSearchPagedSelectFieldsResponse" /> class.</para>
        /// </summary>
        public WireBeneficiaryAdvSearchPagedSelectFieldsResponse()
        {
            this._wireBeneficiaryAdv = new Collection<WireService.WireBeneficiaryAdv>();
