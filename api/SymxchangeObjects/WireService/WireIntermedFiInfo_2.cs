...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireIntermedFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireIntermedFiInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireIntermedFiInfoFields_2))]
    public partial class WireIntermedFiInfo_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireIntermedFiInfoText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireIntermedFiInfoText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireIntermedFiInfo_2" /> class.</para>
        /// </summary>
        public WireIntermedFiInfo_2()
        {
            this._text = new Collection<WireIntermedFiInfoText_2>();
