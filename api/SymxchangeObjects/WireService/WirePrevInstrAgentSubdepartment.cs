...
namespace WireService
{
    ...
    [XmlTypeAttribute("WirePrevInstrAgentSubdepartment", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WirePrevInstrAgentSubdepartment", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WirePrevInstrAgentSubdepartment
    {
        ...
        [XmlElementAttribute("PrevInstrAgentSubdepartment", Order=1, Form=XmlSchemaForm.Unqualified)]
        public string PrevInstrAgentSubdepartment { get; set; }
    }
}
