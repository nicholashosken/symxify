...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireInitgPtySubdepartment", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireInitgPtySubdepartment", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireInitgPtySubdepartment
    {
        ...
        [XmlElementAttribute("InitgPtySubdepartment", Order=1, Form=XmlSchemaForm.Unqualified)]
        public string InitgPtySubdepartment { get; set; }
    }
}
