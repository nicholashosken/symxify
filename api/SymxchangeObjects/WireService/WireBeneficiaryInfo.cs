...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireBeneficiaryInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireBeneficiaryInfo", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireBeneficiaryInfo
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireBeneficiaryInfoText> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireBeneficiaryInfoText> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireBeneficiaryInfo" /> class.</para>
        /// </summary>
        public WireBeneficiaryInfo()
        {
            this._text = new Collection<WireBeneficiaryInfoText>();
