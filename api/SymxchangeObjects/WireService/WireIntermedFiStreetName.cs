...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireIntermedFiStreetName", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve", AnonymousType=true)]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireIntermedFiStreetName", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/retrieve")]
    public partial class WireIntermedFiStreetName
    {
        ...
        [XmlElementAttribute("IntermedFiStreetName", Order=1, Form=XmlSchemaForm.Unqualified)]
        public string IntermedFiStreetName { get; set; }
    }
}
