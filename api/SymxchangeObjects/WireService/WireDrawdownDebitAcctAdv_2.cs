...
namespace WireService
{
    ...
    [XmlTypeAttribute("WireDrawdownDebitAcctAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlRootAttribute("WireDrawdownDebitAcctAdv", Namespace="http://www.symxchange.generated.symitar.com/crud/wire/dto/update")]
    [XmlIncludeAttribute(typeof(WireDrawdownDebitAcctAdvFields_2))]
    public partial class WireDrawdownDebitAcctAdv_2
    {
        ...
        [XmlIgnoreAttribute()]
        private Collection<WireDrawdownDebitAcctAdvText_2> _text;
        
        [XmlElementAttribute("Text", Order=1, Form=XmlSchemaForm.Unqualified)]
        public Collection<WireDrawdownDebitAcctAdvText_2> Text
        {
            get
            {
                return _text;
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="WireDrawdownDebitAcctAdv_2" /> class.</para>
        /// </summary>
        public WireDrawdownDebitAcctAdv_2()
        {
            this._text = new Collection<WireDrawdownDebitAcctAdvText_2>();
