...
namespace CreditReportService
{
    ...
    [XmlTypeAttribute("CreditReportBaseRequest", Namespace="http://www.symxchange.generated.symitar.com/noncrud/creditreport/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    [XmlIncludeAttribute(typeof(ImportReportRequest))]
    [XmlIncludeAttribute(typeof(OrderReportRequest))]
    public partial class CreditReportBaseRequest
    {
        
        [XmlElementAttribute("Credentials", Order=0, Form=XmlSchemaForm.Unqualified)]
        public CreditReportService.AdminCredentialsChoice Credentials { get; set; }
        
        [XmlElementAttribute("DeviceInformation", Order=1, Form=XmlSchemaForm.Unqualified)]
        public CreditReportService.DeviceInformation DeviceInformation { get; set; }
