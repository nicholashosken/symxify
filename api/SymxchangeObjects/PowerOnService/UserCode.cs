...
namespace PowerOnService
{
    ...
    [XmlTypeAttribute("UserCode", Namespace="http://www.symxchange.generated.symitar.com/noncrud/poweron/dto")]
    ...
    public partial class UserCode
    {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UserCode" /> class.</para>
        /// </summary>
        public UserCode()
        {
