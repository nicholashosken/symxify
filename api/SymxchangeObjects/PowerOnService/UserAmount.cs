...
namespace PowerOnService
{
    ...
    [XmlTypeAttribute("UserAmount", Namespace="http://www.symxchange.generated.symitar.com/noncrud/poweron/dto")]
    ...
    public partial class UserAmount
    {
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="UserAmount" /> class.</para>
        /// </summary>
        public UserAmount()
        {
