...
namespace PowerOnService
{
    ...
    [XmlTypeAttribute("MCWPowerOnExecutionRequest", Namespace="http://www.symxchange.generated.symitar.com/noncrud/poweron/dto")]
    [DebuggerStepThroughAttribute()]
    [DesignerCategoryAttribute("code")]
    public partial class McwPowerOnExecutionRequest
    {
        
        [XmlElementAttribute("Credentials", Order=0, Form=XmlSchemaForm.Unqualified)]
        public PowerOnService.CredentialsChoice Credentials { get; set; }
        
        [XmlElementAttribute("DeviceInformation", Order=1, Form=XmlSchemaForm.Unqualified)]
        public PowerOnService.DeviceInformation DeviceInformation { get; set; }
        
        [XmlElementAttribute("Header", Order=2, Form=XmlSchemaForm.Unqualified)]
        public McwExecutionHeader Header { get; set; }
        
        [XmlElementAttribute("Body", Order=3, Form=XmlSchemaForm.Unqualified)]
        public McwExecutionRequestBody Body { get; set; }
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="McwPowerOnExecutionRequest" /> class.</para>
        /// </summary>
        public McwPowerOnExecutionRequest()
        {
