...
namespace PowerOnService
{
    ...
    [XmlTypeAttribute("ExecutionHeader", Namespace="http://www.symxchange.generated.symitar.com/noncrud/poweron/dto")]
    ...
    public partial class ExecutionHeader
    {
        ...
        [XmlElementAttribute("RGState", Order=1, Form=XmlSchemaForm.Unqualified)]
        ...
        /// <summary>
        /// <para xml:lang="en">Initializes a new instance of the <see cref="ExecutionHeader" /> class.</para>
        /// </summary>
